...
class MappingWebEndpointPathMapperTests {
	...
	void defaultConfiguration() {
		...
		assertThat(PathMapper.getRootPath(Collections.singletonList(mapper), EndpointId.of_RENAMED("test"))).isEqualTo("test");
	}
	...
	void userConfiguration() {
		...
		assertThat(PathMapper.getRootPath(Collections.singletonList(mapper), EndpointId.of_RENAMED("test")))
				.isEqualTo("custom");
	}
	...
	void mixedCaseDefaultConfiguration() {
		MappingWebEndpointPathMapper mapper = new MappingWebEndpointPathMapper(Collections.emptyMap());
		assertThat(PathMapper.getRootPath(Collections.singletonList(mapper), EndpointId.of_RENAMED("testEndpoint")))
