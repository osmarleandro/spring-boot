...
class MappingWebEndpointPathMapperTests {
	...
	void defaultConfiguration() {
		...
		assertThat(PathMapper.getRootPath(Collections.singletonList(mapper), new EndpointId("test"))).isEqualTo("test");
	}
	...
	void userConfiguration() {
		...
		assertThat(PathMapper.getRootPath(Collections.singletonList(mapper), new EndpointId("test")))
				.isEqualTo("custom");
	}
	...
	void mixedCaseDefaultConfiguration() {
		MappingWebEndpointPathMapper mapper = new MappingWebEndpointPathMapper(Collections.emptyMap());
		assertThat(PathMapper.getRootPath(Collections.singletonList(mapper), new EndpointId("testEndpoint")))
