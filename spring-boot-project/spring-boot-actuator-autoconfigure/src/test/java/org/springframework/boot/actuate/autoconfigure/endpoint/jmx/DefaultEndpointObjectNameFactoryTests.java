...
class DefaultEndpointObjectNameFactoryTests {
	...
	void generateObjectName() {
		ObjectName objectName = generateObjectName(endpoint(new EndpointId("test")));
	...
	void generateObjectNameWithCapitalizedId() {
		ObjectName objectName = generateObjectName(endpoint(new EndpointId("testEndpoint")));
	...
	private void assertUniqueObjectName() {
		ExposableJmxEndpoint endpoint = endpoint(new EndpointId("test"));
