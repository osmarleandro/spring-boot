...
class DefaultEndpointObjectNameFactoryTests {
	...
	void generateObjectName() {
		ObjectName objectName = generateObjectName(endpoint(EndpointId_RENAMED.of("test")));
	...
	void generateObjectNameWithCapitalizedId() {
		ObjectName objectName = generateObjectName(endpoint(EndpointId_RENAMED.of("testEndpoint")));
	...
	private void assertUniqueObjectName() {
		ExposableJmxEndpoint endpoint = endpoint(EndpointId_RENAMED.of("test"));
	...
	private ExposableJmxEndpoint endpoint(EndpointId_RENAMED id) {
