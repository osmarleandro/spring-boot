...
class DefaultEndpointObjectNameFactoryTests {
	...
	void generateObjectName() {
		ObjectName objectName = generateObjectName(EndpointId.of("test").endpoint());
	...
	void generateObjectNameWithCapitalizedId() {
		ObjectName objectName = generateObjectName(EndpointId.of("testEndpoint").endpoint());
	...
	private void assertUniqueObjectName() {
		ExposableJmxEndpoint endpoint = EndpointId.of("test").endpoint();
