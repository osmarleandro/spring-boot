 ...
 * {@link DiskSpaceHealthIndicator_RENAMED}.
 *
...
public class DiskSpaceHealthContributorAutoConfiguration {
	...
	public DiskSpaceHealthIndicator_RENAMED diskSpaceHealthIndicator(DiskSpaceHealthIndicatorProperties properties) {
		return new DiskSpaceHealthIndicator_RENAMED(properties.getPath(), properties.getThreshold());
	}
