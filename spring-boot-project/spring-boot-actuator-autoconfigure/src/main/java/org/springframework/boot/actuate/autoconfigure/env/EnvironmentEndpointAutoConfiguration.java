...
import org.springframework.boot.actuate.env.EnvironmentEndpointWebExtension_RENAMED;
...
public class EnvironmentEndpointAutoConfiguration {
	...
	public EnvironmentEndpointWebExtension_RENAMED environmentEndpointWebExtension(EnvironmentEndpoint environmentEndpoint) {
		return new EnvironmentEndpointWebExtension_RENAMED(environmentEndpoint);
	}
