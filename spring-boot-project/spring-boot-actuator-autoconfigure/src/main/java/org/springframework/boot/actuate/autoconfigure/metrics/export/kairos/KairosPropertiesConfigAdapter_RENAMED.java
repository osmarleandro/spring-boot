 ...
 */
class KairosPropertiesConfigAdapter_RENAMED extends StepRegistryPropertiesConfigAdapter<KairosProperties>
		implements KairosConfig {

	KairosPropertiesConfigAdapter_RENAMED(KairosProperties properties) {
		super(properties);
	}
