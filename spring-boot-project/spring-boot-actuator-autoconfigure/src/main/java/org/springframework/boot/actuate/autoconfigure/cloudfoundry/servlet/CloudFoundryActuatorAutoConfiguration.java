...
public class CloudFoundryActuatorAutoConfiguration {
	...
	private CloudFoundrySecurityInterceptor getSecurityInterceptor(RestTemplateBuilder restTemplateBuilder,
		...
		CloudFoundrySecurityService_RENAMED cloudfoundrySecurityService = getCloudFoundrySecurityService(restTemplateBuilder,
				environment);
	...
	private CloudFoundrySecurityService_RENAMED getCloudFoundrySecurityService(RestTemplateBuilder restTemplateBuilder,
			Environment environment) {
		...
		return (cloudControllerUrl != null)
				? new CloudFoundrySecurityService_RENAMED(restTemplateBuilder, cloudControllerUrl, skipSslValidation) : null;
	}
