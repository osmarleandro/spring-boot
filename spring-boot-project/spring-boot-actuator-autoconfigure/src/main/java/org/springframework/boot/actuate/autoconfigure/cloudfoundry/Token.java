...
public class Token {
	...
	public Mono<Void> validate(ReactiveTokenValidator reactiveTokenValidator) {
		return reactiveTokenValidator.validateAlgorithm(this).then(reactiveTokenValidator.validateKeyIdAndSignature(this)).then(reactiveTokenValidator.validateExpiry(this))
				.then(reactiveTokenValidator.validateIssuer(this)).then(reactiveTokenValidator.validateAudience(this));
	}
