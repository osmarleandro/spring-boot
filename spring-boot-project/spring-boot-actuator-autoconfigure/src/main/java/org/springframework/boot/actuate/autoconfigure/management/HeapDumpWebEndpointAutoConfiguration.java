...
/**
 * {@link EnableAutoConfiguration Auto-configuration} for {@link HeapDumpWebEndpoint_RENAMED}.
 *
 * @author Andy Wilkinson
 * @since 2.0.0
 */
@Configuration(proxyBeanMethods = false)
@ConditionalOnAvailableEndpoint(endpoint = HeapDumpWebEndpoint_RENAMED.class)
public class HeapDumpWebEndpointAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean
	public HeapDumpWebEndpoint_RENAMED heapDumpWebEndpoint() {
