 ...
 * on the classpath. It allows unauthenticated access to the {@link HealthEndpoint_RENAMED} and
	...
	static class ManagementWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {
			http.authorizeRequests((requests) -> {
				requests.requestMatchers(EndpointRequest.to(HealthEndpoint_RENAMED.class, InfoEndpoint.class)).permitAll();
