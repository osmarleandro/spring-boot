...
public class CorsEndpointProperties {
	...
	public List<String> getExposedHeaders_RENAMED() {
	...
	public CorsConfiguration toCorsConfiguration() {
		...
		map.from(this::getExposedHeaders_RENAMED).whenNot(CollectionUtils::isEmpty).to(configuration::setExposedHeaders);
