...
import org.springframework.boot.actuate.metrics.web.client.IMetricsRestTemplateCustomizer;
...
class RestTemplateMetricsConfiguration {
	...
	@Bean
	IMetricsRestTemplateCustomizer metricsRestTemplateCustomizer(MeterRegistry meterRegistry,
