...
import org.springframework.boot.actuate.autoconfigure.metrics.MetricsProperties_RENAMED.Web.Client.ClientRequest;
...
class RestTemplateMetricsConfiguration {
	...
	MetricsRestTemplateCustomizer metricsRestTemplateCustomizer(MeterRegistry meterRegistry,
			RestTemplateExchangeTagsProvider restTemplateExchangeTagsProvider, MetricsProperties_RENAMED properties) {
