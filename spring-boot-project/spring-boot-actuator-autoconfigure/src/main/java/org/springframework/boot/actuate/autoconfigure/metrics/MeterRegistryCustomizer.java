...
public interface MeterRegistryCustomizer<T extends MeterRegistry> {
	...
	@Test
	default
	void configureShouldApplyBinder(MeterRegistryConfigurerTests meterRegistryConfigurerTests) {
		...
		verify(meterRegistryConfigurerTests.mockBinder).bindTo(meterRegistryConfigurerTests.mockRegistry);
	}
