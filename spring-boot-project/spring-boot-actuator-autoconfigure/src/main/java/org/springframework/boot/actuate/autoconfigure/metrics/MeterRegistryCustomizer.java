...
public interface MeterRegistryCustomizer<T extends MeterRegistry> {
	...
	@Test
	default
	void configureShouldApplyFilter(MeterRegistryConfigurerTests meterRegistryConfigurerTests) {
		...
		verify(meterRegistryConfigurerTests.mockConfig).meterFilter(meterRegistryConfigurerTests.mockFilter);
	}
