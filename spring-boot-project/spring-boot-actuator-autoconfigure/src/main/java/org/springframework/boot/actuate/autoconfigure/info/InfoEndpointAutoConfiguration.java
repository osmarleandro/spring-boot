...
/**
 * {@link EnableAutoConfiguration Auto-configuration} for the {@link InfoEndpoint_RENAMED}.
 *
 * @author Phillip Webb
 * @since 2.0.0
 */
@Configuration(proxyBeanMethods = false)
@ConditionalOnAvailableEndpoint(endpoint = InfoEndpoint_RENAMED.class)
@AutoConfigureAfter(InfoContributorAutoConfiguration.class)
public class InfoEndpointAutoConfiguration {

	@Bean
	@ConditionalOnMissingBean
	public InfoEndpoint_RENAMED infoEndpoint(ObjectProvider<InfoContributor> infoContributors) {
