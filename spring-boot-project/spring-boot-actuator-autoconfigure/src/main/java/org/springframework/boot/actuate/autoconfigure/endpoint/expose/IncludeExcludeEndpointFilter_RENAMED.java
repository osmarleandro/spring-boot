 ...
 * @since 2.2.7
 */
public class IncludeExcludeEndpointFilter_RENAMED<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	/**
	 * Create a new {@link IncludeExcludeEndpointFilter_RENAMED} with include/exclude rules bound
	 ...
	 */
	public IncludeExcludeEndpointFilter_RENAMED(Class<E> endpointType, Environment environment, String prefix,
	...
	private IncludeExcludeEndpointFilter_RENAMED(Class<E> endpointType, Environment environment, String prefix,
	...
	/**
	 * Create a new {@link IncludeExcludeEndpointFilter_RENAMED} with specific include/exclude
	 * rules.
	 * @param endpointType the endpoint type that should be considered (other types always
	 * match)
	 ...
	 * @param defaultIncludes the default {@code includes} to use when none are specified.
	 */
	public IncludeExcludeEndpointFilter_RENAMED(Class<E> endpointType, Collection<String> include, Collection<String> exclude,
			String... defaultIncludes) {
	...
	private IncludeExcludeEndpointFilter_RENAMED(Class<E> endpointType, Collection<String> include, Collection<String> exclude,
			EndpointPatterns defaultIncludes) {
