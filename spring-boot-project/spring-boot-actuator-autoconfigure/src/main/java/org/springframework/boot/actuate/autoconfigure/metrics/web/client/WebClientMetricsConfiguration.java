...
import org.springframework.boot.actuate.metrics.web.reactive.client.MetricsWebClientCustomizer_RENAMED;
...
class WebClientMetricsConfiguration {
	...
	@Bean
	MetricsWebClientCustomizer_RENAMED metricsWebClientCustomizer(MeterRegistry meterRegistry,
		...
		return new MetricsWebClientCustomizer_RENAMED(meterRegistry, tagsProvider, request.getMetricName(),
				request.getAutotime());
	}
