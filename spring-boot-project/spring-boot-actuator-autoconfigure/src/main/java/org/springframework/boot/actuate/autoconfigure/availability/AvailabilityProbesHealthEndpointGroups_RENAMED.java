 ...
 * @author Brian Clozel
 */
class AvailabilityProbesHealthEndpointGroups_RENAMED implements HealthEndpointGroups {
	...
	AvailabilityProbesHealthEndpointGroups_RENAMED(HealthEndpointGroups groups) {
