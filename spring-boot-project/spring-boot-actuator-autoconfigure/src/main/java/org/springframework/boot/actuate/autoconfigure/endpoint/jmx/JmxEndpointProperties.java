...
public class JmxEndpointProperties {
	...
	@Test
	void generateObjectNameWithCapitalizedId(DefaultEndpointObjectNameFactoryTests defaultEndpointObjectNameFactoryTests) {
		ObjectName objectName = defaultEndpointObjectNameFactoryTests.generateObjectName(defaultEndpointObjectNameFactoryTests.endpoint(EndpointId.of("testEndpoint")));
