...
public class HttpTraceProperties {
	 ...
	 */
	private Set<Include_RENAMED> include = new HashSet<>(Include_RENAMED.defaultIncludes());

	public Set<Include_RENAMED> getInclude() {
		return this.include;
	}

	public void setInclude(Set<Include_RENAMED> include) {
