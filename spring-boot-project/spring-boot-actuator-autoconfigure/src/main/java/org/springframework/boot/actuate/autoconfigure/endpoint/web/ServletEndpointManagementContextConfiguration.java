...
public class ServletEndpointManagementContextConfiguration {
	...
	public static class WebMvcServletEndpointManagementContextConfiguration {
		...
		public ServletEndpointRegistrar servletEndpointRegistrar(WebEndpointProperties properties,
			...
			return new ServletEndpointRegistrar(dispatcherServletPath.getRelativePath(properties.getExposure().getBasePath(this)),
	...
	public static class JerseyServletEndpointManagementContextConfiguration {
		...
		public ServletEndpointRegistrar servletEndpointRegistrar(WebEndpointProperties properties,
			...
			return new ServletEndpointRegistrar(jerseyApplicationPath.getRelativePath(properties.getExposure().getBasePath(this)),
					servletEndpointsSupplier.getEndpoints());
		}
