...
public class ServletEndpointManagementContextConfiguration {
	...
	@Bean
	public IncludeExcludeEndpointFilter_RENAMED<ExposableServletEndpoint> servletExposeExcludePropertyEndpointFilter(
			WebEndpointProperties properties) {
		WebEndpointProperties.Exposure exposure = properties.getExposure();
		return new IncludeExcludeEndpointFilter_RENAMED<>(ExposableServletEndpoint.class, exposure.getInclude(),
				exposure.getExclude());
	}
