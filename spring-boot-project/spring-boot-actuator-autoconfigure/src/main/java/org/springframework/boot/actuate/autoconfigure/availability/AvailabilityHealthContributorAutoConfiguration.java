...
public class AvailabilityHealthContributorAutoConfiguration {
	...
	public LivenessStateHealthIndicator_RENAMED livenessStateHealthIndicator(ApplicationAvailability applicationAvailability) {
		return new LivenessStateHealthIndicator_RENAMED(applicationAvailability);
	}
