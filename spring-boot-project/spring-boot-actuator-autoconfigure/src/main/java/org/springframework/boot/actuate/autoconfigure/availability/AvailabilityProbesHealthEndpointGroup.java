...
class AvailabilityProbesHealthEndpointGroup implements HealthEndpointGroup {
	...
	@Test
	void showComponentsReturnsFalse(AvailabilityProbesHealthEndpointGroupTests availabilityProbesHealthEndpointGroupTests) {
		assertThat(showComponents(mock(SecurityContext.class))).isFalse();
	}
