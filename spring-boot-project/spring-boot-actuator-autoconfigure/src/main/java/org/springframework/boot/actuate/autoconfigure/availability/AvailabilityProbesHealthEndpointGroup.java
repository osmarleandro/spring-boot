...
class AvailabilityProbesHealthEndpointGroup implements HealthEndpointGroup {
	...
	@Test
	void isMemberWhenNotMemberReturnsFalse(AvailabilityProbesHealthEndpointGroupTests availabilityProbesHealthEndpointGroupTests) {
		assertThat(isMember("c")).isFalse();
	}
