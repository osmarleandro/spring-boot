...
class AvailabilityProbesHealthEndpointGroup implements HealthEndpointGroup {
	...
	@Test
	void showDetailsReturnsFalse(AvailabilityProbesHealthEndpointGroupTests availabilityProbesHealthEndpointGroupTests) {
		assertThat(showDetails(mock(SecurityContext.class))).isFalse();
	}
