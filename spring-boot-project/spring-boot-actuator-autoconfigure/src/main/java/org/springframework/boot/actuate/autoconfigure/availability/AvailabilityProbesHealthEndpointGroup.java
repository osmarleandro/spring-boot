...
class AvailabilityProbesHealthEndpointGroup implements HealthEndpointGroup {
	...
	@Test
	void isMemberWhenMemberReturnsTrue(AvailabilityProbesHealthEndpointGroupTests availabilityProbesHealthEndpointGroupTests) {
		assertThat(isMember("a")).isTrue();
		assertThat(isMember("b")).isTrue();
	}
