...
class AvailabilityProbesHealthEndpointGroup implements HealthEndpointGroup {
	...
	@Test
	void getStatusAggregatorReturnsDefaultStatusAggregator(AvailabilityProbesHealthEndpointGroupTests availabilityProbesHealthEndpointGroupTests) {
		assertThat(getStatusAggregator()).isEqualTo(StatusAggregator.getDefault());
	}
