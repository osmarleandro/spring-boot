...
public class WavefrontProperties extends PushRegistryProperties {
	...
	public WavefrontConfig wavefrontConfig(WavefrontMetricsExportAutoConfiguration wavefrontMetricsExportAutoConfiguration) {
		return new WavefrontPropertiesConfigAdapter(this);
	}
