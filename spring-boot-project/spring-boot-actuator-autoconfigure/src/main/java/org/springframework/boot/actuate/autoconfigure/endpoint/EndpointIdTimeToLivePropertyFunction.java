 ...
 * @author Phillip Webb
 */
public class EndpointIdTimeToLivePropertyFunction implements Function<EndpointId, Long> {

	public static final Bindable<Duration> DURATION = Bindable.of(Duration.class);
