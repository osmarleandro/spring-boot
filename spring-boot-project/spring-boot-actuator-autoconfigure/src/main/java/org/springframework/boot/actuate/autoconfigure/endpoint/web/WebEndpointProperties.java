...
public class WebEndpointProperties {
	...
	@Bean
	public IncludeExcludeEndpointFilter<ExposableControllerEndpoint> controllerExposeExcludePropertyEndpointFilter(WebEndpointAutoConfiguration webEndpointAutoConfiguration) {
