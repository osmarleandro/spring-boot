...
public class MetricsProperties {
	...
	<T> T lookupWithFallbackToAll(PropertiesMeterFilter propertiesMeterFilter, Map<String, T> values, Id id, T defaultValue) {
		if (values.isEmpty()) {
			return defaultValue;
		}
		return propertiesMeterFilter.doLookup(values, id, () -> values.getOrDefault("all", defaultValue));
	}
