...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	@Test
	void matchWhenExposeMatchesAndExcludeMatchesShouldNotMatch(IncludeExcludeEndpointFilterTests includeExcludeEndpointFilterTests) {
		includeExcludeEndpointFilterTests.setupFilter("bar,baz", "baz");
