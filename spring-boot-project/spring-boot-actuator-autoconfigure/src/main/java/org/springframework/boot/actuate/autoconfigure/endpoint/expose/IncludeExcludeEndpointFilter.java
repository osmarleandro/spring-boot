...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	@Test
	void matchWhenMixedCaseShouldMatch(IncludeExcludeEndpointFilterTests includeExcludeEndpointFilterTests) {
		includeExcludeEndpointFilterTests.setupFilter("foo-bar", "");
		assertThat(includeExcludeEndpointFilterTests.match(EndpointId.of("fooBar"))).isTrue();
	}
