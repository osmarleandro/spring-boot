...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	@Test
	void matchWhenExposeIsEmptyAndExcludeIsEmptyAndInDefaultShouldMatch(IncludeExcludeEndpointFilterTests includeExcludeEndpointFilterTests) {
		includeExcludeEndpointFilterTests.setupFilter("", "");
		assertThat(includeExcludeEndpointFilterTests.match(EndpointId.of("def"))).isTrue();
	}
