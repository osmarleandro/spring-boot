...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	@Test
	void matchWhenExposeMatchesAndExcludeIsEmptyShouldMatch(IncludeExcludeEndpointFilterTests includeExcludeEndpointFilterTests) {
		includeExcludeEndpointFilterTests.setupFilter("bar", "");
