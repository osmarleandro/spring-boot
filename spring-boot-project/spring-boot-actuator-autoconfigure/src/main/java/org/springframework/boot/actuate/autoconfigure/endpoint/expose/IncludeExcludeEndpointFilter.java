...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	@Test
	void matchWhenIncludeIsAsteriskShouldMatchAll(IncludeExcludeEndpointFilterTests includeExcludeEndpointFilterTests) {
		includeExcludeEndpointFilterTests.setupFilter("*", "buz");
		assertThat(includeExcludeEndpointFilterTests.match(EndpointId.of("bar"))).isTrue();
		assertThat(includeExcludeEndpointFilterTests.match(EndpointId.of("baz"))).isTrue();
