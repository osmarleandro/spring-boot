...
public class IncludeExcludeEndpointFilter<E extends ExposableEndpoint<?>> implements EndpointFilter<E> {
	...
	@Test // gh-20997
	void matchWhenDashInName(IncludeExcludeEndpointFilterTests includeExcludeEndpointFilterTests) throws Exception {
		includeExcludeEndpointFilterTests.setupFilter("bus-refresh", "");
		assertThat(includeExcludeEndpointFilterTests.match(EndpointId.of("bus-refresh"))).isTrue();
	}
