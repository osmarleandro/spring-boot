...
public class ExposeExcludePropertyEndpointFilter<E extends ExposableEndpoint<?>>
	...
	@Test
	void matchWhenExposeDoesNotMatchAndExcludeIsEmptyShouldNotMatch(ExposeExcludePropertyEndpointFilterTests exposeExcludePropertyEndpointFilterTests) {
		exposeExcludePropertyEndpointFilterTests.setupFilter("bar", "");
