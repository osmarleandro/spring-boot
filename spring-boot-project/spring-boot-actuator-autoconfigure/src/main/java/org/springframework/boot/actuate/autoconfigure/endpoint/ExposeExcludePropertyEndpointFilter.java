...
public class ExposeExcludePropertyEndpointFilter<E extends ExposableEndpoint<?>>
	...
	@Test
	void matchWhenExposeIsEmptyAndExcludeIsEmptyAndInDefaultShouldMatch(ExposeExcludePropertyEndpointFilterTests exposeExcludePropertyEndpointFilterTests) {
		exposeExcludePropertyEndpointFilterTests.setupFilter("", "");
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("def"))).isTrue();
	}
