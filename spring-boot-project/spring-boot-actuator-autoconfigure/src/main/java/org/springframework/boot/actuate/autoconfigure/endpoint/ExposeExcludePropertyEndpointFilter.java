...
public class ExposeExcludePropertyEndpointFilter<E extends ExposableEndpoint<?>>
	...
	@Test
	void matchWhenMixedCaseShouldMatch(ExposeExcludePropertyEndpointFilterTests exposeExcludePropertyEndpointFilterTests) {
		exposeExcludePropertyEndpointFilterTests.setupFilter("foo-bar", "");
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("fooBar"))).isTrue();
	}
