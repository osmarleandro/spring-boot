...
public class ExposeExcludePropertyEndpointFilter<E extends ExposableEndpoint<?>>
	...
	@Test
	void matchWhenIncludeIsAsteriskShouldMatchAll(ExposeExcludePropertyEndpointFilterTests exposeExcludePropertyEndpointFilterTests) {
		exposeExcludePropertyEndpointFilterTests.setupFilter("*", "buz");
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("bar"))).isTrue();
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("baz"))).isTrue();
