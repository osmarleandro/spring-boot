...
public class ExposeExcludePropertyEndpointFilter<E extends ExposableEndpoint<?>>
	...
	@Test
	void matchWhenExcludeIsAsteriskShouldMatchNone(ExposeExcludePropertyEndpointFilterTests exposeExcludePropertyEndpointFilterTests) {
		exposeExcludePropertyEndpointFilterTests.setupFilter("bar,baz,buz", "*");
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("bar"))).isFalse();
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("baz"))).isFalse();
		assertThat(exposeExcludePropertyEndpointFilterTests.match(EndpointId.of("buz"))).isFalse();
	}
