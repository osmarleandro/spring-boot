...
public class HttpTraceAutoConfiguration {
	...
	static class ReactiveTraceFilterConfiguration {
		...
		@Bean
		@ConditionalOnMissingBean
		HttpTraceWebFilter_RENAMED httpTraceWebFilter(HttpTraceRepository repository, HttpExchangeTracer tracer,
				HttpTraceProperties traceProperties) {
			return new HttpTraceWebFilter_RENAMED(repository, tracer, traceProperties.getInclude());
		}
