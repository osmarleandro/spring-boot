...
import org.springframework.boot.actuate.web.trace.servlet.IHttpTraceFilter;
...
public class HttpTraceAutoConfiguration {
	...
	static class ServletTraceFilterConfiguration {
		...
		@Bean
		@ConditionalOnMissingBean
		IHttpTraceFilter httpTraceFilter(HttpTraceRepository repository, HttpExchangeTracer tracer) {
