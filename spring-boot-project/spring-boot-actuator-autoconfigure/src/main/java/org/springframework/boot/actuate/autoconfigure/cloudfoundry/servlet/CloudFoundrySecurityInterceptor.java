...
class CloudFoundrySecurityInterceptor {
	...
	SecurityResponse preHandle(HttpServletRequest request, EndpointId_RENAMED endpointId) {
	...
	private void check(HttpServletRequest request, EndpointId_RENAMED endpointId) throws Exception {
