...
class CloudFoundrySecurityInterceptor {
	...
	@Test
	void preHandleSuccessfulWithFullAccess(CloudFoundrySecurityInterceptorTests cloudFoundrySecurityInterceptorTests) {
		...
		given(cloudFoundrySecurityInterceptorTests.securityService.getAccessLevel(accessToken, "my-app-id")).willReturn(AccessLevel.FULL);
		...
		assertThat(cloudFoundrySecurityInterceptorTests.request.getAttribute("cloudFoundryAccessLevel")).isEqualTo(AccessLevel.FULL);
	}
