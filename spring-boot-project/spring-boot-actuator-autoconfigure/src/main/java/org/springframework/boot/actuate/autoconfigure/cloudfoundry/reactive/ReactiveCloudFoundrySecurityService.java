...
class ReactiveCloudFoundrySecurityService {
	...
	@Test
	void getAccessLevelWhenForbiddenShouldThrowException(ReactiveCloudFoundrySecurityServiceTests reactiveCloudFoundrySecurityServiceTests) throws Exception {
		reactiveCloudFoundrySecurityServiceTests.prepareResponse((response) -> response.setResponseCode(403));
