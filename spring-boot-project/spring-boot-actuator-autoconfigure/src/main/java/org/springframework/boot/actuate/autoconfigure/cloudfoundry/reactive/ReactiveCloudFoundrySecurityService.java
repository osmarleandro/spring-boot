...
class ReactiveCloudFoundrySecurityService {
	...
	public void expectRequest(ReactiveCloudFoundrySecurityServiceTests reactiveCloudFoundrySecurityServiceTests, Consumer<RecordedRequest> consumer) throws InterruptedException {
		consumer.accept(reactiveCloudFoundrySecurityServiceTests.server.takeRequest());
	}
