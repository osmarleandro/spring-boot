...
class ReactiveCloudFoundrySecurityService {
	...
	@Test
	void getAccessLevelWhenTokenIsNotValidShouldThrowException(ReactiveCloudFoundrySecurityServiceTests reactiveCloudFoundrySecurityServiceTests) throws Exception {
		reactiveCloudFoundrySecurityServiceTests.prepareResponse((response) -> response.setResponseCode(401));
