...
class ReactiveCloudFoundrySecurityService {
	...
	@Test
	void getAccessLevelWhenSpaceDeveloperShouldReturnFull(ReactiveCloudFoundrySecurityServiceTests reactiveCloudFoundrySecurityServiceTests) throws Exception {
