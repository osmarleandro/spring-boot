...
class ReactiveCloudFoundrySecurityService {
	...
	@Test
	void preHandleWhenCloudFoundrySecurityServiceIsNullShouldReturnError(ReactiveCloudFoundrySecurityInterceptorTests reactiveCloudFoundrySecurityInterceptorTests) {
		reactiveCloudFoundrySecurityInterceptorTests.interceptor = new CloudFoundrySecurityInterceptor(reactiveCloudFoundrySecurityInterceptorTests.tokenValidator, null, "my-app-id");
		...
		StepVerifier.create(reactiveCloudFoundrySecurityInterceptorTests.interceptor.preHandle(request, "/a"))
