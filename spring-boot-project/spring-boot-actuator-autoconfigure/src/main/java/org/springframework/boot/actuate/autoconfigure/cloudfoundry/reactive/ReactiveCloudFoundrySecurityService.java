...
class ReactiveCloudFoundrySecurityService {
	...
	@AfterEach
	void shutdown(ReactiveCloudFoundrySecurityServiceTests reactiveCloudFoundrySecurityServiceTests) throws Exception {
		reactiveCloudFoundrySecurityServiceTests.server.shutdown();
	}
