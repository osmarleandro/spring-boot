...
class CloudFoundrySecurityService {
	...
	@Test
	void getAccessLevelWhenForbiddenShouldThrowException(CloudFoundrySecurityServiceTests cloudFoundrySecurityServiceTests) {
		...
		assertThatExceptionOfType(CloudFoundryAuthorizationException.class)
				...
				.satisfies(cloudFoundrySecurityServiceTests.reasonRequirement(Reason.ACCESS_DENIED));
	}
