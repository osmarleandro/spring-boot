...
class CloudFoundrySecurityService {
	...
	@Test
	void operationWithSecurityInterceptorForbidden(CloudFoundryMvcWebEndpointIntegrationTests cloudFoundryMvcWebEndpointIntegrationTests) {
		given(getAccessLevel(any(), eq("app-id"))).willReturn(AccessLevel.RESTRICTED);
