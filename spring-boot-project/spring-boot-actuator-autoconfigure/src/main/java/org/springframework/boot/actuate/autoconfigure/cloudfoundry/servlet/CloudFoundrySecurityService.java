...
class CloudFoundrySecurityService {
	...
	@Test
	void preHandleWhenApplicationIdIsNullShouldReturnFalse(CloudFoundrySecurityInterceptorTests cloudFoundrySecurityInterceptorTests) {
		cloudFoundrySecurityInterceptorTests.interceptor = new CloudFoundrySecurityInterceptor(cloudFoundrySecurityInterceptorTests.tokenValidator, this, null);
