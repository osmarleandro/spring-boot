...
class CloudFoundrySecurityService {
	...
	@Test
	void getAccessLevelWhenTokenIsNotValidShouldThrowException(CloudFoundrySecurityServiceTests cloudFoundrySecurityServiceTests) {
		...
		assertThatExceptionOfType(CloudFoundryAuthorizationException.class)
				...
				.satisfies(cloudFoundrySecurityServiceTests.reasonRequirement(Reason.INVALID_TOKEN));
	}
