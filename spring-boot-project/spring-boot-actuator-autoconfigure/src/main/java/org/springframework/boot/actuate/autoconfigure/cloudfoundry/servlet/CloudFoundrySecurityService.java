...
class CloudFoundrySecurityService {
	...
	@Test
	void validateTokenWhenAudienceIsNotValidShouldThrowException(TokenValidatorTests tokenValidatorTests) throws Exception {
		...
		assertThatExceptionOfType(CloudFoundryAuthorizationException.class).isThrownBy(
				...
				.satisfies(tokenValidatorTests.reasonRequirement(Reason.INVALID_AUDIENCE));
	}
