...
import org.springframework.boot.actuate.metrics.cache.IHazelcastCacheMeterBinderProvider;
...
class CacheMeterBinderProvidersConfiguration {
	...
	static class HazelcastCacheMeterBinderProviderConfiguration {
		...
		@Bean
		IHazelcastCacheMeterBinderProvider hazelcastCacheMeterBinderProvider() {
