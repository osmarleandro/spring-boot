...
import org.springframework.boot.actuate.metrics.cache.IEhCache2CacheMeterBinderProvider;
...
class CacheMeterBinderProvidersConfiguration {
	...
	static class EhCache2CacheMeterBinderProviderConfiguration {
		...
		@Bean
		IEhCache2CacheMeterBinderProvider ehCache2CacheMeterBinderProvider() {
