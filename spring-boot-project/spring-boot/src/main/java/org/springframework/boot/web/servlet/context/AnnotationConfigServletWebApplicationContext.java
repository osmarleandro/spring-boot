...
public class AnnotationConfigServletWebApplicationContext extends GenericWebApplicationContext
	...
	public MockMvc createSecureMockMvc(ControllerEndpointWebMvcIntegrationTests controllerEndpointWebMvcIntegrationTests) {
		return controllerEndpointWebMvcIntegrationTests.doCreateMockMvc(springSecurity());
	}
