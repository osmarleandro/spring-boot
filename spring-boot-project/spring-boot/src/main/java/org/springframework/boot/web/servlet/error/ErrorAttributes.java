...
public interface ErrorAttributes {
	...
	public
	default boolean includeStackTrace(ManagementErrorEndpoint managementErrorEndpoint, ServletWebRequest request) {
		switch (managementErrorEndpoint.errorProperties.getIncludeStacktrace()) {
		case ALWAYS:
			return true;
		case ON_PARAM:
		case ON_TRACE_PARAM:
			return managementErrorEndpoint.getBooleanParameter(request, "trace");
		default:
			return false;
		}
	}
