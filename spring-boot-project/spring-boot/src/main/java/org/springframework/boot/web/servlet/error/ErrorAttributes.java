...
public interface ErrorAttributes {
	...
	@Test
	default
	void errorResponseParamsTrue(ManagementErrorEndpointTests managementErrorEndpointTests) {
		...
		managementErrorEndpointTests.request.addParameter("trace", "true");
		managementErrorEndpointTests.request.addParameter("message", "true");
