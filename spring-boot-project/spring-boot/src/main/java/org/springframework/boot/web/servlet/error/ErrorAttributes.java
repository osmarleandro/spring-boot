...
public interface ErrorAttributes {
	...
	public default boolean includeMessage(ManagementErrorEndpoint managementErrorEndpoint, ServletWebRequest request) {
		switch (managementErrorEndpoint.errorProperties.getIncludeMessage()) {
		case ALWAYS:
			return true;
		case ON_PARAM:
			return managementErrorEndpoint.getBooleanParameter(request, "message");
		default:
			return false;
		}
	}
