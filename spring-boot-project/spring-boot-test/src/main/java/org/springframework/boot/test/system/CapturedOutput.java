...
public interface CapturedOutput extends CharSequence {
	...
	@Test
	default
	void shouldNotDenyNorLogIfMaxUrisIsNotReached(WebClientMetricsConfigurationTests webClientMetricsConfigurationTests) {
		webClientMetricsConfigurationTests.contextRunner.withPropertyValues("management.metrics.web.client.max-uri-tags=5").run((context) -> {
