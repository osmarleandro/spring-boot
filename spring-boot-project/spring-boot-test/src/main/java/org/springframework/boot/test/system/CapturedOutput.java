...
public interface CapturedOutput extends CharSequence {
	...
	@Test
	default
	void afterMaxUrisReachedFurtherUrisAreDenied(RestTemplateMetricsConfigurationTests restTemplateMetricsConfigurationTests) {
		restTemplateMetricsConfigurationTests.contextRunner.withPropertyValues("management.metrics.web.client.max-uri-tags=2").run((context) -> {
