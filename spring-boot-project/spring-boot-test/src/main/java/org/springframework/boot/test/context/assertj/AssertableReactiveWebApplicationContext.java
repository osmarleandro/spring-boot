...
public interface AssertableReactiveWebApplicationContext
	...
	public default URI getLocationHeader(ReactiveManagementWebSecurityAutoConfigurationTests reactiveManagementWebSecurityAutoConfigurationTests, String path) {
