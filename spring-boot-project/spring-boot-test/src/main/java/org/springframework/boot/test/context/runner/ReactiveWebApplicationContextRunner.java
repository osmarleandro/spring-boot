...
public final class ReactiveWebApplicationContextRunner extends
	...
	@Test
	public
	void tagsProviderWhenIgnoreTrailingSlashIsFalse(WebFluxMetricsAutoConfigurationTests webFluxMetricsAutoConfigurationTests) {
		withPropertyValues("management.metrics.web.server.request.ignore-trailing-slash=false")
				.run((context) -> {
