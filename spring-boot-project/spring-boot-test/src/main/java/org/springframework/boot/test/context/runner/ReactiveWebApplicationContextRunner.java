...
import org.springframework.boot.actuate.autoconfigure.security.reactive.ReactiveManagementWebSecurityAutoConfigurationTests.CustomSecurityConfiguration;
...
public final class ReactiveWebApplicationContextRunner extends
	...
	@Test
	public
	void backsOffIfCustomSecurityIsAdded(ReactiveManagementWebSecurityAutoConfigurationTests reactiveManagementWebSecurityAutoConfigurationTests) {
		withUserConfiguration(CustomSecurityConfiguration.class).run((context) -> {
			...
			assertThat(reactiveManagementWebSecurityAutoConfigurationTests.getLocationHeader(context, "/foo")).isNull();
		});
	}
