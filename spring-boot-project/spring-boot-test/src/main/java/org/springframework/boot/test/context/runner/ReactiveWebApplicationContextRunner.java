...
public final class ReactiveWebApplicationContextRunner extends
	...
	@Test
	public
	void cloudFoundryManagementEndpointsDisabled(ReactiveCloudFoundryActuatorAutoConfigurationTests reactiveCloudFoundryActuatorAutoConfigurationTests) {
		withPropertyValues("VCAP_APPLICATION=---", "management.cloudfoundry.enabled:false").run(
