...
import org.springframework.boot.actuate.autoconfigure.metrics.web.reactive.WebFluxMetricsAutoConfigurationTests.CustomWebFluxTagsProviderConfig;
...
public final class ReactiveWebApplicationContextRunner extends
	...
	@Test
	public
	void shouldNotOverrideCustomTagsProvider(WebFluxMetricsAutoConfigurationTests webFluxMetricsAutoConfigurationTests) {
