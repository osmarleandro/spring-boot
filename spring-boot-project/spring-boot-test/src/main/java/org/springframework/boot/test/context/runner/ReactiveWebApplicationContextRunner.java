...
public final class ReactiveWebApplicationContextRunner extends
	...
	@Test
	public
	void permitAllForHealth(ReactiveManagementWebSecurityAutoConfigurationTests reactiveManagementWebSecurityAutoConfigurationTests) {
		run((context) -> assertThat(reactiveManagementWebSecurityAutoConfigurationTests.getAuthenticateHeader(context, "/actuator/health")).isNull());
	}
