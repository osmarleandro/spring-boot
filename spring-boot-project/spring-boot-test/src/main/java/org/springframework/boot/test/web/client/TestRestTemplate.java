...
public class TestRestTemplate {
	...
	@Test
	public
	void search(JolokiaEndpointAutoConfigurationIntegrationTests jolokiaEndpointAutoConfigurationIntegrationTests) {
		ResponseEntity<String> response = getForEntity("/actuator/jolokia/search/java.lang:*",
				String.class);
