...
public class TestRestTemplate {
	...
	@Test
	public
	void list(JolokiaEndpointAutoConfigurationIntegrationTests jolokiaEndpointAutoConfigurationIntegrationTests) {
		ResponseEntity<String> response = getForEntity("/actuator/jolokia/list/java.lang/type=Memory/attr", String.class);
