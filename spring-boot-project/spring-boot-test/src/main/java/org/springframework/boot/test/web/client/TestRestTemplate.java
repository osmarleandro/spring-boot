...
public class TestRestTemplate {
	...
	@Test
	public
	void jolokiaIsExposed(JolokiaEndpointAutoConfigurationIntegrationTests jolokiaEndpointAutoConfigurationIntegrationTests) {
		ResponseEntity<String> response = getForEntity("/actuator/jolokia", String.class);
