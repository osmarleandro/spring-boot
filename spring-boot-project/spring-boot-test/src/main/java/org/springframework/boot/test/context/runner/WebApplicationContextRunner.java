...
import org.springframework.boot.actuate.autoconfigure.endpoint.web.jersey.JerseyWebEndpointManagementContextConfigurationTests;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void jerseyWebEndpointsResourcesRegistrarForEndpointsIsAutoConfigured(JerseyWebEndpointManagementContextConfigurationTests jerseyWebEndpointManagementContextConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(JerseyWebEndpointsResourcesRegistrar.class));
	}
