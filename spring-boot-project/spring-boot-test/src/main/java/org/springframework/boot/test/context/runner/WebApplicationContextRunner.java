...
import org.springframework.boot.actuate.autoconfigure.metrics.web.servlet.WebMvcMetricsAutoConfigurationTests.TagsContributorsConfiguration;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void whenTagContributorsAreDefinedThenTagsProviderUsesThem(WebMvcMetricsAutoConfigurationTests webMvcMetricsAutoConfigurationTests) {
