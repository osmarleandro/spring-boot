...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void jerseyApplicationPathIsAutoConfiguredWhenNeeded(JerseySameManagementContextConfigurationTests jerseySameManagementContextConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(DefaultJerseyApplicationPath.class));
	}
