...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void timerWorksWithTimedAnnotationsWhenAutoTimeRequestsIsFalse(WebMvcMetricsAutoConfigurationTests webMvcMetricsAutoConfigurationTests) {
		withUserConfiguration(TestController.class)
				...
				.withPropertyValues("management.metrics.web.server.request.autotime.enabled=false").run((context) -> {
					MeterRegistry registry = webMvcMetricsAutoConfigurationTests.getInitializedMeterRegistry(context, "/test3");
