...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void autoConfigurationIsDisabledByDefault(HttpTraceAutoConfigurationTests httpTraceAutoConfigurationTests) {
		run((context) -> assertThat(context).doesNotHaveBean(HttpTraceAutoConfiguration.class));
	}
