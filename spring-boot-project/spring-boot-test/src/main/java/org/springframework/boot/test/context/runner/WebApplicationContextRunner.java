...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void permitAllForInfo(ManagementWebSecurityAutoConfigurationTests managementWebSecurityAutoConfigurationTests) {
		run((context) -> {
			HttpStatus status = managementWebSecurityAutoConfigurationTests.getResponseStatus(context, "/actuator/info");
