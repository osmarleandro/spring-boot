...
import org.springframework.boot.actuate.autoconfigure.web.jersey.JerseySameManagementContextConfigurationTests.ConfigWithJerseyApplicationPath;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void jerseyApplicationPathIsConditionalOnMissingBean(JerseySameManagementContextConfigurationTests jerseySameManagementContextConfigurationTests) {
		withUserConfiguration(ConfigWithJerseyApplicationPath.class).run((context) -> {
