...
import org.springframework.boot.actuate.autoconfigure.health.HealthEndpointAutoConfigurationTests.StatusAggregatorConfiguration;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void runWhenHasStatusAggregatorBeanIgnoresProperties(HealthEndpointAutoConfigurationTests healthEndpointAutoConfigurationTests) {
		withUserConfiguration(StatusAggregatorConfiguration.class)
