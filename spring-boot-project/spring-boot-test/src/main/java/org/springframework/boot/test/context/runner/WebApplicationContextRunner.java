...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void requestsWithDisallowedMethodsAreRejected(WebMvcEndpointCorsIntegrationTests webMvcEndpointCorsIntegrationTests) {
		withPropertyValues("management.endpoints.web.cors.allowed-origins:foo.example.com")
				.run(webMvcEndpointCorsIntegrationTests.withMockMvc((mockMvc) -> mockMvc
