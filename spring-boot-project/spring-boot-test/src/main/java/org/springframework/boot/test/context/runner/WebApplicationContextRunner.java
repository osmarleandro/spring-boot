...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void webEndpointsAreDisabledByDefault(WebMvcEndpointExposureIntegrationTests webMvcEndpointExposureIntegrationTests) {
		run((context) -> {
			WebTestClient client = webMvcEndpointExposureIntegrationTests.createClient(context);
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "beans")).isFalse();
