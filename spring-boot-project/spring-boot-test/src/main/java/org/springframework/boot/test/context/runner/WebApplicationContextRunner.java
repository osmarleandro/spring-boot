...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void singleWebEndpointCanBeExposed(WebMvcEndpointExposureIntegrationTests webMvcEndpointExposureIntegrationTests) {
		WebApplicationContextRunner contextRunner = withPropertyValues("management.endpoints.web.exposure.include=beans");
		contextRunner.run((context) -> {
			...
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "conditions")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "configprops")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "custommvc")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "customservlet")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "env")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "health")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "info")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "mappings")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.POST, "shutdown")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "threaddump")).isFalse();
			assertThat(webMvcEndpointExposureIntegrationTests.isExposed(client, HttpMethod.GET, "httptrace")).isFalse();
		});
	}
