...
import org.springframework.boot.actuate.autoconfigure.health.HealthEndpointAutoConfigurationTests.HttpCodeStatusMapperConfiguration;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void runWhenHasHttpCodeStatusMapperBeanIgnoresProperties(HealthEndpointAutoConfigurationTests healthEndpointAutoConfigurationTests) {
		withUserConfiguration(HttpCodeStatusMapperConfiguration.class)
