...
import org.springframework.boot.actuate.autoconfigure.audit.AuditAutoConfigurationTests.CustomAuditListenerConfiguration;
import org.springframework.boot.actuate.autoconfigure.audit.AuditAutoConfigurationTests.TestAuditListener;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void ownAuditListener(AuditAutoConfigurationTests auditAutoConfigurationTests) {
