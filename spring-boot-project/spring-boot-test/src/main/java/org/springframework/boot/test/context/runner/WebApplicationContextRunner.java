...
import org.springframework.boot.actuate.autoconfigure.health.HealthEndpointAutoConfigurationTests.HealthEndpointGroupsConfiguration;
import org.springframework.boot.actuate.autoconfigure.health.HealthEndpointAutoConfigurationTests.TestHealthEndpointGroupsPostProcessor;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void runWhenHasHealthEndpointGroupsPostProcessorPerformsProcessing(HealthEndpointAutoConfigurationTests healthEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoint.health.group.ready.include=*").withUserConfiguration(
