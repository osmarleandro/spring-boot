...
import org.springframework.boot.actuate.autoconfigure.health.HealthEndpointAutoConfigurationTests.HealthContributorRegistryConfiguration;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void runWhenHasHealthContributorRegistryBeanDoesNotCreateAdditionalRegistry(HealthEndpointAutoConfigurationTests healthEndpointAutoConfigurationTests) {
		withUserConfiguration(HealthContributorRegistryConfiguration.class).run((context) -> {
