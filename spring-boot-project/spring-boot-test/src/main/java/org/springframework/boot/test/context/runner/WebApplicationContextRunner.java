...
import org.springframework.boot.actuate.autoconfigure.metrics.web.servlet.WebMvcMetricsAutoConfigurationTests.TagsProviderConfiguration;
import org.springframework.boot.actuate.autoconfigure.metrics.web.servlet.WebMvcMetricsAutoConfigurationTests.TestWebMvcTagsProvider;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void tagsProviderBacksOff(WebMvcMetricsAutoConfigurationTests webMvcMetricsAutoConfigurationTests) {
		withUserConfiguration(TagsProviderConfiguration.class).run((context) -> {
