...
import org.springframework.boot.actuate.autoconfigure.web.trace.HttpTraceAutoConfigurationTests.CustomHttpExchangeTracer;
import org.springframework.boot.actuate.autoconfigure.web.trace.HttpTraceAutoConfigurationTests.CustomTracerConfiguration;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void usesUserProvidedTracer(HttpTraceAutoConfigurationTests httpTraceAutoConfigurationTests) {
