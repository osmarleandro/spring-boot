...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void jerseyRequestMatcherProviderConditionalOnResourceConfigClass(SecurityRequestMatchersManagementContextConfigurationTests securityRequestMatchersManagementContextConfigurationTests) {
		withClassLoader(new FilteredClassLoader("org.glassfish.jersey.server.ResourceConfig"))
