...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void usesMatchersBasedOffConfiguredActuatorBasePath(ManagementWebSecurityAutoConfigurationTests managementWebSecurityAutoConfigurationTests) {
		withPropertyValues("management.endpoints.web.base-path=/").run((context) -> {
			HttpStatus status = managementWebSecurityAutoConfigurationTests.getResponseStatus(context, "/health");
