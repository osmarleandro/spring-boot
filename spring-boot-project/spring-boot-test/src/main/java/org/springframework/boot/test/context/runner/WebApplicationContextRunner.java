...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void jmxEndpointsAreExposed(JmxEndpointIntegrationTests jmxEndpointIntegrationTests) {
		run((context) -> {
			MBeanServer mBeanServer = context.getBean(MBeanServer.class);
			jmxEndpointIntegrationTests.checkEndpointMBeans(mBeanServer, new String[] { "beans", "conditions", "configprops", "env", "health",
