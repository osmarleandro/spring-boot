...
public final class WebApplicationContextRunner extends
	...
	public void checkEndpointMBeans(JmxEndpointIntegrationTests jmxEndpointIntegrationTests, MBeanServer mBeanServer, String[] enabledEndpoints, String[] disabledEndpoints) {
		for (String enabledEndpoint : enabledEndpoints) {
			assertThat(jmxEndpointIntegrationTests.isRegistered(mBeanServer, jmxEndpointIntegrationTests.getDefaultObjectName(enabledEndpoint)))
					.as(String.format("Endpoint %s", enabledEndpoint)).isTrue();
		}
		for (String disabledEndpoint : disabledEndpoints) {
			assertThat(jmxEndpointIntegrationTests.isRegistered(mBeanServer, jmxEndpointIntegrationTests.getDefaultObjectName(disabledEndpoint)))
