...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void webEndpointsCanBeExposed(WebMvcEndpointExposureIntegrationTests webMvcEndpointExposureIntegrationTests) {
		WebApplicationContextRunner contextRunner = withPropertyValues("management.endpoints.web.exposure.include=*");
