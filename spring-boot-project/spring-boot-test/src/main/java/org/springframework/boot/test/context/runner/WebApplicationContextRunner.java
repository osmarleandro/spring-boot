...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void securesEverythingElse(ManagementWebSecurityAutoConfigurationTests managementWebSecurityAutoConfigurationTests) {
		run((context) -> {
			HttpStatus status = managementWebSecurityAutoConfigurationTests.getResponseStatus(context, "/actuator");
