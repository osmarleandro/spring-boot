...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void logFileWebEndpointCanBeDisabled(LogFileWebEndpointAutoConfigurationTests logFileWebEndpointAutoConfigurationTests) {
		withPropertyValues("logging.file.name:test.log", "management.endpoint.logfile.enabled:false")
