...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void singleJmxEndpointCanBeExposed(JmxEndpointIntegrationTests jmxEndpointIntegrationTests) {
		withPropertyValues("management.endpoints.jmx.exposure.include=beans").run((context) -> {
			MBeanServer mBeanServer = context.getBean(MBeanServer.class);
			jmxEndpointIntegrationTests.checkEndpointMBeans(mBeanServer, new String[] { "beans" }, new String[] { "conditions", "configprops",
