...
import org.springframework.boot.actuate.autoconfigure.web.trace.HttpTraceAutoConfigurationTests.CustomFilterConfiguration;
import org.springframework.boot.actuate.autoconfigure.web.trace.HttpTraceAutoConfigurationTests.CustomHttpTraceFilter;
...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void usesUserProvidedServletFilter(HttpTraceAutoConfigurationTests httpTraceAutoConfigurationTests) {
