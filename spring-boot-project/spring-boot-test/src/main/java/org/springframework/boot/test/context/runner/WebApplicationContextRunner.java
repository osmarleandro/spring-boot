...
public final class WebApplicationContextRunner extends
	...
	public ObjectName getDefaultObjectName(JmxEndpointIntegrationTests jmxEndpointIntegrationTests, String endpointId) {
		return jmxEndpointIntegrationTests.getObjectName("org.springframework.boot", endpointId);
	}
