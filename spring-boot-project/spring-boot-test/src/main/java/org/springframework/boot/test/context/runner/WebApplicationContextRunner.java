...
public final class WebApplicationContextRunner extends
	...
	@Test
	public
	void configurationConditionalOnRequestMatcherClass(SecurityRequestMatchersManagementContextConfigurationTests securityRequestMatchersManagementContextConfigurationTests) {
		withClassLoader(
