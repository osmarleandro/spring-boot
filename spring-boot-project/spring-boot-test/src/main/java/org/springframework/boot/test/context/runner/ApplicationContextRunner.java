...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateIndicator(CouchbaseHealthContributorAutoConfigurationTests couchbaseHealthContributorAutoConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(CouchbaseHealthIndicator.class)
