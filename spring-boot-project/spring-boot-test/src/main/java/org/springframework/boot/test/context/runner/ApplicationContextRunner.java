...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void thresholdCanBeCustomized(DiskSpaceHealthContributorAutoConfigurationTests diskSpaceHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.diskspace.threshold=20MB").run((context) -> {
