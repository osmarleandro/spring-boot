...
import org.springframework.boot.actuate.autoconfigure.metrics.export.dynatrace.DynatraceMetricsExportAutoConfigurationTests.CustomConfigConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomConfigToBeUsed(DynatraceMetricsExportAutoConfigurationTests dynatraceMetricsExportAutoConfigurationTests) {
