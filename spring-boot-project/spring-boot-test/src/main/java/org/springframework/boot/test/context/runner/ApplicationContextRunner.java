...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void getGroupWhenGroupDoesNotExistReturnsNull(AutoConfiguredHealthEndpointGroupsTests autoConfiguredHealthEndpointGroupsTests) {
		withPropertyValues("management.endpoint.health.group.a.include=*").run((context) -> {
