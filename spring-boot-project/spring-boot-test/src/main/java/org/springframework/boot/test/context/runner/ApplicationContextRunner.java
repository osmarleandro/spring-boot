...
import org.springframework.boot.actuate.autoconfigure.metrics.export.elastic.ElasticMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfigurationCanBeDisabledWithSpecificEnabledProperty(ElasticMetricsExportAutoConfigurationTests elasticMetricsExportAutoConfigurationTests) {
