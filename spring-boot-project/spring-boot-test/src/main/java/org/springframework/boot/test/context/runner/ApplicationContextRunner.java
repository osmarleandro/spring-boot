...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldHaveEndpointBeanEvenIfDefaultIsDisabled(InfoEndpointAutoConfigurationTests infoEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoint.default.enabled:false")
