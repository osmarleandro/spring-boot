...
import org.springframework.boot.actuate.autoconfigure.logging.LoggersEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenEnabledPropertyIsFalseShouldNotHaveEndpointBean(LoggersEndpointAutoConfigurationTests loggersEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoint.loggers.enabled:false")
