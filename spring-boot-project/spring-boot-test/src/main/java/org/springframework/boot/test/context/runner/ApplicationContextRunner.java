...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void endpointIsAutoConfigured(ScheduledTasksEndpointAutoConfigurationTests scheduledTasksEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoints.web.exposure.include=scheduledtasks")
