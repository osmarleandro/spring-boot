...
import org.springframework.boot.actuate.autoconfigure.metrics.SystemMetricsAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.SystemMetricsAutoConfigurationTests.CustomUptimeMetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomUptimeMetricsToBeUsed(SystemMetricsAutoConfigurationTests systemMetricsAutoConfigurationTests) {
		withUserConfiguration(CustomUptimeMetricsConfiguration.class).run(
