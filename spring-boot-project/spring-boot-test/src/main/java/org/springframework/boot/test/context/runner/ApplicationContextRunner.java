...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfiguredNonSupportedCacheManagerIsIgnored(CacheMetricsAutoConfigurationTests cacheMetricsAutoConfigurationTests) {
		withPropertyValues("spring.cache.type=simple", "spring.cache.cache-names=cache1,cache2")
				.run((context) -> {
