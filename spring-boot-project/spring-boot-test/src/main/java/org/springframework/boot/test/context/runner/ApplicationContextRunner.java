...
import org.springframework.boot.actuate.autoconfigure.metrics.r2dbc.ConnectionPoolMetricsAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.r2dbc.ConnectionPoolMetricsAutoConfigurationTests.ConnectionFactoryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void connectionPoolExposedAsConnectionFactoryTypeIsInstrumented(ConnectionPoolMetricsAutoConfigurationTests connectionPoolMetricsAutoConfigurationTests) {
		withUserConfiguration(ConnectionFactoryConfiguration.class).run((context) -> {
