...
import org.springframework.boot.actuate.autoconfigure.metrics.export.ganglia.GangliaMetricsExportAutoConfigurationTests.CustomRegistryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomRegistryToBeUsed(GangliaMetricsExportAutoConfigurationTests gangliaMetricsExportAutoConfigurationTests) {
