...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfiguresItsConfigCollectorRegistryAndMeterRegistry(PrometheusMetricsExportAutoConfigurationTests prometheusMetricsExportAutoConfigurationTests) {
