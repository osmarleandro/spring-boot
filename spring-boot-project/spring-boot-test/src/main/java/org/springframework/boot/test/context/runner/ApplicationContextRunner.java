...
import org.springframework.boot.actuate.autoconfigure.metrics.export.humio.HumioMetricsExportAutoConfigurationTests.CustomConfigConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomConfigToBeUsed(HumioMetricsExportAutoConfigurationTests humioMetricsExportAutoConfigurationTests) {
