...
import org.springframework.boot.actuate.autoconfigure.influx.InfluxDbHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenDisabledShouldNotCreateIndicator(InfluxDbHealthContributorAutoConfigurationTests influxDbHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.influxdb.enabled:false")
