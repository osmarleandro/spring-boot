...
import org.springframework.boot.actuate.autoconfigure.metrics.export.prometheus.PrometheusMetricsExportAutoConfigurationTests.CustomCollectorRegistryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomCollectorRegistryToBeUsed(PrometheusMetricsExportAutoConfigurationTests prometheusMetricsExportAutoConfigurationTests) {
