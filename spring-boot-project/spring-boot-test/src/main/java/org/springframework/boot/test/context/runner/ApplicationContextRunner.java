...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateIndicator(InfluxDbHealthContributorAutoConfigurationTests influxDbHealthContributorAutoConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(InfluxDbHealthIndicator.class));
	}
