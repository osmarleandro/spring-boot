...
import org.springframework.boot.actuate.autoconfigure.metrics.export.prometheus.PrometheusMetricsExportAutoConfigurationTests.CustomEndpointConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomScrapeEndpointToBeUsed(PrometheusMetricsExportAutoConfigurationTests prometheusMetricsExportAutoConfigurationTests) {
