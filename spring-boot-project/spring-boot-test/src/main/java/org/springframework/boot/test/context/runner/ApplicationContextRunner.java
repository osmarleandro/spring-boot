...
import org.springframework.boot.actuate.autoconfigure.metrics.export.dynatrace.DynatraceMetricsExportAutoConfigurationTests.CustomRegistryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomRegistryToBeUsed(DynatraceMetricsExportAutoConfigurationTests dynatraceMetricsExportAutoConfigurationTests) {
		withUserConfiguration(CustomRegistryConfiguration.class).with(dynatraceMetricsExportAutoConfigurationTests.mandatoryProperties())
