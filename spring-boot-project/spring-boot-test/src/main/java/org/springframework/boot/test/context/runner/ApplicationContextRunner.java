...
import org.springframework.boot.actuate.autoconfigure.jms.JmsHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateIndicator(JmsHealthContributorAutoConfigurationTests jmsHealthContributorAutoConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(JmsHealthIndicator.class));
	}
