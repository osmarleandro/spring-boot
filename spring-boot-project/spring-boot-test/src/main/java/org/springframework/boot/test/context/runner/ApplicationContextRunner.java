...
import org.springframework.boot.actuate.autoconfigure.info.InfoEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenEnabledPropertyIsFalseShouldNotHaveEndpointBean(InfoEndpointAutoConfigurationTests infoEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoint.info.enabled:false")
