...
import org.springframework.boot.actuate.autoconfigure.condition.ConditionsReportEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldHaveEndpointBean(ConditionsReportEndpointAutoConfigurationTests conditionsReportEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoints.web.exposure.include=conditions")
