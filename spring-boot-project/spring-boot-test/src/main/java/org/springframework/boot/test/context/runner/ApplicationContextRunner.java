...
import org.springframework.boot.actuate.autoconfigure.metrics.Log4J2MetricsWithLog4jLoggerContextAutoConfigurationTests.CustomLog4J2MetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomLog4J2MetricsToBeUsed(Log4J2MetricsWithLog4jLoggerContextAutoConfigurationTests log4j2MetricsWithLog4jLoggerContextAutoConfigurationTests) {
		assertThat(LogManager.getContext().getClass().getName())
				.isEqualTo("org.apache.logging.log4j.core.LoggerContext");
		withUserConfiguration(CustomLog4J2MetricsConfiguration.class).run(
