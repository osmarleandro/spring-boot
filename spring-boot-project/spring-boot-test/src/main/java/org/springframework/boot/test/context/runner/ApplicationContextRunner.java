...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfiguredDataSourceExposedAsConnectionFactoryTypeIsInstrumented(ConnectionPoolMetricsAutoConfigurationTests connectionPoolMetricsAutoConfigurationTests) {
		withPropertyValues(
