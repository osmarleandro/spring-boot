...
import org.springframework.boot.actuate.autoconfigure.endpoint.condition.ConditionalOnAvailableEndpointTests.ComponentEnabledIfEndpointIsExposedConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void outcomeWhenIncludeMatchesShouldMatchWithExtensionsAndComponents(ConditionalOnAvailableEndpointTests conditionalOnAvailableEndpointTests) {
		withUserConfiguration(ComponentEnabledIfEndpointIsExposedConfiguration.class)
