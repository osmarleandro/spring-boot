...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateHealthIndicator(Neo4jHealthContributorAutoConfigurationTests neo4jHealthContributorAutoConfigurationTests) {
		withUserConfiguration(Neo4jConfiguration.class).run((context) -> assertThat(context)
