...
import org.springframework.boot.actuate.autoconfigure.metrics.export.kairos.KairosMetricsExportAutoConfigurationTests.CustomConfigConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomConfigToBeUsed(KairosMetricsExportAutoConfigurationTests kairosMetricsExportAutoConfigurationTests) {
