...
import org.springframework.boot.actuate.autoconfigure.metrics.LogbackMetricsAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.LogbackMetricsAutoConfigurationTests.CustomLogbackMetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomLogbackMetricsToBeUsed(LogbackMetricsAutoConfigurationTests logbackMetricsAutoConfigurationTests) {
		withUserConfiguration(CustomLogbackMetricsConfiguration.class).run(
