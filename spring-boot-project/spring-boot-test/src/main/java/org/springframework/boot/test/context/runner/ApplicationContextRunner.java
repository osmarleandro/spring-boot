...
import org.springframework.boot.actuate.autoconfigure.endpoint.EndpointAutoConfigurationTests.ConverterConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void mapShouldUseConfigurationConverter(EndpointAutoConfigurationTests endpointAutoConfigurationTests) {
		withUserConfiguration(ConverterConfiguration.class).run((context) -> {
