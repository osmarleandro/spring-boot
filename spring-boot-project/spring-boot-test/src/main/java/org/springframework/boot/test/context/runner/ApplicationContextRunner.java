...
import org.springframework.boot.actuate.autoconfigure.metrics.CompositeMeterRegistryAutoConfigurationTests.NoMeterRegistryConfig;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void registerWhenHasNoMeterRegistryShouldRegisterEmptyNoOpComposite(CompositeMeterRegistryAutoConfigurationTests compositeMeterRegistryAutoConfigurationTests) {
		withUserConfiguration(NoMeterRegistryConfig.class).run((context) -> {
