...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenDisabledShouldNotCreateIndicator(CassandraReactiveHealthContributorAutoConfigurationTests cassandraReactiveHealthContributorAutoConfigurationTests) {
