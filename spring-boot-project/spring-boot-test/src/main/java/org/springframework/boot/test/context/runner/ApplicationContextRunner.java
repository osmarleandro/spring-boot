...
import org.springframework.boot.actuate.autoconfigure.startup.StartupEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenMissingAppStartupShouldNotHaveStartupEndpoint(StartupEndpointAutoConfigurationTests startupEndpointAutoConfigurationTests) {
