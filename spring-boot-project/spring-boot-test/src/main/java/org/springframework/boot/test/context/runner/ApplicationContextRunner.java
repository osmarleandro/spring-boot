...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfiguredEntityManagerFactoryWithoutStatsIsNotInstrumented(HibernateMetricsAutoConfigurationTests hibernateMetricsAutoConfigurationTests) {
		withPropertyValues("spring.jpa.properties.hibernate.generate_statistics:false")
				.run((context) -> {
