...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void readinessIndicatorWhenPropertyEnabledAddsBeans(AvailabilityHealthContributorAutoConfigurationTests availabilityHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.readinessState.enabled=true")
