...
import org.springframework.boot.actuate.autoconfigure.system.DiskSpaceHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenPathDoesNotExistShouldCreateIndicator(DiskSpaceHealthContributorAutoConfigurationTests diskSpaceHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.diskspace.path=does/not/exist")
