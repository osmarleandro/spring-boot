...
import org.springframework.boot.actuate.autoconfigure.metrics.export.simple.SimpleMetricsExportAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.export.simple.SimpleMetricsExportAutoConfigurationTests.CustomRegistryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void backsOffEntirelyWithCustomMeterRegistry(SimpleMetricsExportAutoConfigurationTests simpleMetricsExportAutoConfigurationTests) {
		withUserConfiguration(CustomRegistryConfiguration.class).run((context) -> assertThat(context)
