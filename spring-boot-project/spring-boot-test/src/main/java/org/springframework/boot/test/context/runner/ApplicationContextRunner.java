...
import org.springframework.boot.actuate.autoconfigure.redis.RedisReactiveHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWithRegularIndicatorShouldOnlyCreateReactiveIndicator(RedisReactiveHealthContributorAutoConfigurationTests redisReactiveHealthContributorAutoConfigurationTests) {
		withConfiguration(AutoConfigurations.of(RedisHealthContributorAutoConfiguration.class))
