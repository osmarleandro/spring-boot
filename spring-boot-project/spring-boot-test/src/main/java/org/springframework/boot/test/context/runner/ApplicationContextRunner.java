...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void keysToSanitizeCanBeConfiguredViaTheEnvironment(EnvironmentEndpointAutoConfigurationTests environmentEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoints.web.exposure.include=env")
				...
				.run(environmentEndpointAutoConfigurationTests.validateSystemProperties("******", "123456"));
	}
