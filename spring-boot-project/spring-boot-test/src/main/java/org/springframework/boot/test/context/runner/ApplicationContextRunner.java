...
import org.springframework.boot.actuate.autoconfigure.scheduling.ScheduledTasksEndpointAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.scheduling.ScheduledTasksEndpointAutoConfigurationTests.CustomEndpointConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void endpointBacksOffWhenUserProvidedEndpointIsPresent(ScheduledTasksEndpointAutoConfigurationTests scheduledTasksEndpointAutoConfigurationTests) {
		withUserConfiguration(CustomEndpointConfiguration.class).run(
