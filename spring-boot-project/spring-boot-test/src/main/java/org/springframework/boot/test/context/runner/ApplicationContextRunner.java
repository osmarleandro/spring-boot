...
import org.springframework.boot.actuate.autoconfigure.mail.MailHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenDisabledShouldNotCreateIndicator(MailHealthContributorAutoConfigurationTests mailHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.mail.enabled:false")
