...
import org.springframework.boot.actuate.autoconfigure.solr.SolrHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateIndicator(SolrHealthContributorAutoConfigurationTests solrHealthContributorAutoConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(SolrHealthIndicator.class));
	}
