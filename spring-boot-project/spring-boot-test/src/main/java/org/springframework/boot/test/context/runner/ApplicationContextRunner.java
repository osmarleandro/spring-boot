...
import org.springframework.boot.actuate.autoconfigure.metrics.export.jmx.JmxMetricsExportAutoConfigurationTests.CustomConfigConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomConfigToBeUsed(JmxMetricsExportAutoConfigurationTests jmxMetricsExportAutoConfigurationTests) {
