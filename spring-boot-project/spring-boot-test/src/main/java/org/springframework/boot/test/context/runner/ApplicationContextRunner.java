...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWithOnlyRoutingDataSourceShouldIncludeRoutingDataSource(DataSourceHealthContributorAutoConfigurationTests dataSourceHealthContributorAutoConfigurationTests) {
		withUserConfiguration(RoutingDataSourceConfig.class)
