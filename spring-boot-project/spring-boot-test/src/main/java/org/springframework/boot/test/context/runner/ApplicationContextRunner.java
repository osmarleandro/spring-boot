...
import org.springframework.boot.actuate.autoconfigure.metrics.r2dbc.ConnectionPoolMetricsAutoConfigurationTests.TwoConnectionPoolsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allConnectionPoolsCanBeInstrumented(ConnectionPoolMetricsAutoConfigurationTests connectionPoolMetricsAutoConfigurationTests) {
		withUserConfiguration(TwoConnectionPoolsConfiguration.class).run((context) -> {
