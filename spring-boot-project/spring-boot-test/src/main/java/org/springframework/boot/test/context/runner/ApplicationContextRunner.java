...
import org.springframework.boot.actuate.autoconfigure.metrics.jersey.JerseyServerMetricsAutoConfigurationTests.CustomJerseyTagsProvider;
import org.springframework.boot.actuate.autoconfigure.metrics.jersey.JerseyServerMetricsAutoConfigurationTests.CustomJerseyTagsProviderConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void shouldHonorExistingTagProvider(JerseyServerMetricsAutoConfigurationTests jerseyServerMetricsAutoConfigurationTests) {
		jerseyServerMetricsAutoConfigurationTests.webContextRunner.withUserConfiguration(CustomJerseyTagsProviderConfiguration.class)
