...
import org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfigurationTests.TwoHikariDataSourcesConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allHikariDataSourcesCanBeInstrumented(DataSourcePoolMetricsAutoConfigurationTests dataSourcePoolMetricsAutoConfigurationTests) {
		withUserConfiguration(TwoHikariDataSourcesConfiguration.class)
