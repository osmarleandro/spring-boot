...
import org.springframework.boot.actuate.autoconfigure.audit.AuditEventsEndpointAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.audit.AuditEventsEndpointAutoConfigurationTests.CustomAuditEventRepositoryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenRepositoryBeanAvailableShouldHaveEndpointBean(AuditEventsEndpointAutoConfigurationTests auditEventsEndpointAutoConfigurationTests) {
