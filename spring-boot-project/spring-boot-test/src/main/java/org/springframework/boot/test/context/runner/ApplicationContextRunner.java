...
import org.springframework.boot.actuate.autoconfigure.metrics.amqp.RabbitMetricsAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void rabbitmqNativeConnectionFactoryInstrumentationCanBeDisabled(RabbitMetricsAutoConfigurationTests rabbitMetricsAutoConfigurationTests) {
		withPropertyValues("management.metrics.enable.rabbitmq=false").run((context) -> {
