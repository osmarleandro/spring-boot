...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldHaveEndpointBean(IntegrationGraphEndpointAutoConfigurationTests integrationGraphEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoints.web.exposure.include=integrationgraph")
