...
import org.springframework.boot.actuate.autoconfigure.redis.RedisHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateIndicator(RedisHealthContributorAutoConfigurationTests redisHealthContributorAutoConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(RedisHealthIndicator.class)
