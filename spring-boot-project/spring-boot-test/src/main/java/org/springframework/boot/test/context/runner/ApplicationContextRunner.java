...
import org.springframework.boot.actuate.autoconfigure.health.AutoConfiguredHealthEndpointGroupsTests.CustomHttpCodeStatusMapperConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void createWhenHasHttpCodeStatusMapperBeanAndGroupSpecificPropertyReturnsInstanceThatUsesBeanOnlyForUnconfiguredGroups(AutoConfiguredHealthEndpointGroupsTests autoConfiguredHealthEndpointGroupsTests) {
		withUserConfiguration(CustomHttpCodeStatusMapperConfiguration.class)
