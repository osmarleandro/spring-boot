...
import org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfigurationTests.HikariSealingConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void hikariCanBeInstrumentedAfterThePoolHasBeenSealed(DataSourcePoolMetricsAutoConfigurationTests dataSourcePoolMetricsAutoConfigurationTests) {
		withUserConfiguration(HikariSealingConfiguration.class)
