...
import org.springframework.boot.actuate.autoconfigure.management.ThreadDumpEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldHaveEndpointBean(ThreadDumpEndpointAutoConfigurationTests threadDumpEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoints.web.exposure.include=threaddump")
