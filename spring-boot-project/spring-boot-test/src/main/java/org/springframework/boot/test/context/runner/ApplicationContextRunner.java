...
import org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfigurationTests.ProxiedHikariDataSourcesConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void hikariProxiedDataSourceCanBeInstrumented(DataSourcePoolMetricsAutoConfigurationTests dataSourcePoolMetricsAutoConfigurationTests) {
