...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void outcomeWhenIncludeAllJmxAndJmxEnabledAndEnablingEndpointDisabledByDefaultShouldMatchAll(ConditionalOnAvailableEndpointTests conditionalOnAvailableEndpointTests) {
