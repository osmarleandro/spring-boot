...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenDisabledShouldNotCreateIndicator(LdapHealthContributorAutoConfigurationTests ldapHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.ldap.enabled:false")
