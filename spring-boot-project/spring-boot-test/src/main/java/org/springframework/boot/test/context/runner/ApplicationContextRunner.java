...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void outcomeOnCloudFoundryShouldMatchAll(ConditionalOnAvailableEndpointTests conditionalOnAvailableEndpointTests) {
		withPropertyValues("VCAP_APPLICATION:---").run(
