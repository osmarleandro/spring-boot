...
import org.springframework.boot.actuate.autoconfigure.metrics.export.dynatrace.DynatraceMetricsExportAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.export.dynatrace.DynatraceMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void stopsMeterRegistryWhenContextIsClosed(DynatraceMetricsExportAutoConfigurationTests dynatraceMetricsExportAutoConfigurationTests) {
		withUserConfiguration(BaseConfiguration.class).with(dynatraceMetricsExportAutoConfigurationTests.mandatoryProperties()).run((context) -> {
