...
import org.springframework.boot.actuate.autoconfigure.metrics.JvmMetricsAutoConfigurationTests.CustomJvmMemoryMetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomJvmMemoryMetricsToBeUsed(JvmMetricsAutoConfigurationTests jvmMetricsAutoConfigurationTests) {
