...
import org.springframework.boot.actuate.autoconfigure.metrics.export.jmx.JmxMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfiguresItsConfigAndMeterRegistry(JmxMetricsExportAutoConfigurationTests jmxMetricsExportAutoConfigurationTests) {
		withUserConfiguration(BaseConfiguration.class).run(
