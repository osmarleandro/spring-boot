...
import org.springframework.boot.actuate.autoconfigure.metrics.export.ganglia.GangliaMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfigurationCanBeDisabledWithDefaultsEnabledProperty(GangliaMetricsExportAutoConfigurationTests gangliaMetricsExportAutoConfigurationTests) {
