...
import org.springframework.boot.actuate.autoconfigure.metrics.web.client.WebClientMetricsConfigurationTests.CustomTagsProviderConfig;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void shouldNotOverrideCustomTagsProvider(WebClientMetricsConfigurationTests webClientMetricsConfigurationTests) {
		withUserConfiguration(CustomTagsProviderConfig.class).run((context) -> assertThat(context)
