...
import org.springframework.boot.actuate.autoconfigure.metrics.MetricsAutoConfigurationIntegrationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void propertyBasedMeterFilteringIsAutoConfigured(MetricsAutoConfigurationIntegrationTests metricsAutoConfigurationIntegrationTests) {
		withPropertyValues("management.metrics.enable.my.org=false").run((context) -> {
