...
import org.springframework.boot.actuate.autoconfigure.metrics.export.ConditionalOnEnabledMetricsExportAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void exporterCanBeGloballyDisabledWitSpecificOverride(ConditionalOnEnabledMetricsExportAutoConfigurationTests conditionalOnEnabledMetricsExportAutoConfigurationTests) {
