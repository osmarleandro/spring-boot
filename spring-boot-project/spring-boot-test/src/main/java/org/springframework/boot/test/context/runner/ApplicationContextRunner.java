...
import org.springframework.boot.actuate.autoconfigure.hazelcast.HazelcastHealthContributorAutoConfigurationIntegrationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void hazelcastDown(HazelcastHealthContributorAutoConfigurationIntegrationTests hazelcastHealthContributorAutoConfigurationIntegrationTests) {
		run((context) -> {
