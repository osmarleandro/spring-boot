...
import org.springframework.boot.actuate.autoconfigure.cassandra.CassandraHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWithCqlSessionAndCassandraOperationsShouldCreateDriverIndicator(CassandraHealthContributorAutoConfigurationTests cassandraHealthContributorAutoConfigurationTests) {
