...
import org.springframework.boot.actuate.autoconfigure.metrics.export.kairos.KairosMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfigurationCanBeDisabledWithSpecificEnabledProperty(KairosMetricsExportAutoConfigurationTests kairosMetricsExportAutoConfigurationTests) {
