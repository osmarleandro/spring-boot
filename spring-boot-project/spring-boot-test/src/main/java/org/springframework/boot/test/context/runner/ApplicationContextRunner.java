...
import org.springframework.boot.actuate.autoconfigure.metrics.MetricsAutoConfigurationTests.CustomClockConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsACustomClockToBeUsed(MetricsAutoConfigurationTests metricsAutoConfigurationTests) {
