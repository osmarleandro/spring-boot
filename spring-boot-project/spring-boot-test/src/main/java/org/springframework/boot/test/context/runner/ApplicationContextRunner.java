...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void shouldProvideAllNecessaryBeans(JerseyServerMetricsAutoConfigurationTests jerseyServerMetricsAutoConfigurationTests) {
		jerseyServerMetricsAutoConfigurationTests.webContextRunner.run((context) -> assertThat(context).hasSingleBean(DefaultJerseyTagsProvider.class)
