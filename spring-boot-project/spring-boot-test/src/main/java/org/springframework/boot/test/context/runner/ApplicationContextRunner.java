...
import org.springframework.boot.actuate.autoconfigure.integration.IntegrationGraphEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenEnabledPropertyIsFalseShouldNotHaveEndpointBean(IntegrationGraphEndpointAutoConfigurationTests integrationGraphEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoint.integrationgraph.enabled:false").run((context) -> {
