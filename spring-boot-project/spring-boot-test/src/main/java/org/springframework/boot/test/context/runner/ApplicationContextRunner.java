...
import org.springframework.boot.actuate.autoconfigure.availability.AvailabilityProbesAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void probesWhenKubernetesAndPropertyDisabledAddsNotBeans(AvailabilityProbesAutoConfigurationTests availabilityProbesAutoConfigurationTests) {
