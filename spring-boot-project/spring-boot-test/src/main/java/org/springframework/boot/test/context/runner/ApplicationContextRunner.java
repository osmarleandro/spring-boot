...
import org.springframework.boot.actuate.autoconfigure.metrics.JvmMetricsAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.JvmMetricsAutoConfigurationTests.CustomJvmGcMetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomJvmGcMetricsToBeUsed(JvmMetricsAutoConfigurationTests jvmMetricsAutoConfigurationTests) {
		withUserConfiguration(CustomJvmGcMetricsConfiguration.class)
