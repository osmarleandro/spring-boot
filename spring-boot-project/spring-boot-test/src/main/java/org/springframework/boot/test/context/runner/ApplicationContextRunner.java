...
import org.springframework.boot.actuate.autoconfigure.endpoint.EndpointAutoConfigurationTests.GenericConverterConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void mapShouldUseGenericConfigurationConverter(EndpointAutoConfigurationTests endpointAutoConfigurationTests) {
		withUserConfiguration(GenericConverterConfiguration.class).run((context) -> {
