...
import org.springframework.boot.actuate.autoconfigure.metrics.JvmMetricsAutoConfigurationTests.CustomClassLoaderMetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomClassLoaderMetricsToBeUsed(JvmMetricsAutoConfigurationTests jvmMetricsAutoConfigurationTests) {
