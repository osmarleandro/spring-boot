...
import org.springframework.boot.actuate.autoconfigure.context.properties.ConfigurationPropertiesReportEndpointAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.context.properties.ConfigurationPropertiesReportEndpointAutoConfigurationTests.Config;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void keysToSanitizeCanBeConfiguredViaTheEnvironment(ConfigurationPropertiesReportEndpointAutoConfigurationTests configurationPropertiesReportEndpointAutoConfigurationTests) {
		withUserConfiguration(Config.class)
				...
				.run(configurationPropertiesReportEndpointAutoConfigurationTests.validateTestProperties("******", "******"));
	}
