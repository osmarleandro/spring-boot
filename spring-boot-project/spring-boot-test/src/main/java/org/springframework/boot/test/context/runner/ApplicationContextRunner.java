...
import org.springframework.boot.actuate.autoconfigure.metrics.export.newrelic.NewRelicMetricsExportAutoConfigurationTests.CustomRegistryConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsRegistryToBeCustomized(NewRelicMetricsExportAutoConfigurationTests newRelicMetricsExportAutoConfigurationTests) {
