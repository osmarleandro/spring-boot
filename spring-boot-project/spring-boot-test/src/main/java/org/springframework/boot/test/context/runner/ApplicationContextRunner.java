...
import org.springframework.boot.actuate.autoconfigure.health.AutoConfiguredHealthEndpointGroupsTests.CustomStatusAggregatorGroupAConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void createWhenHasGroupSpecificStatusAggregatorPropertyAndGroupQualifiedBeanReturnsInstanceWithBeanUsedForExpectedGroups(AutoConfiguredHealthEndpointGroupsTests autoConfiguredHealthEndpointGroupsTests) {
		withUserConfiguration(CustomStatusAggregatorGroupAConfiguration.class)
