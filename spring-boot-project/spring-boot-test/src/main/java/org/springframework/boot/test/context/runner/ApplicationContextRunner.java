...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runShouldCreateIndicator(MailHealthContributorAutoConfigurationTests mailHealthContributorAutoConfigurationTests) {
		run((context) -> assertThat(context).hasSingleBean(MailHealthIndicator.class));
	}
