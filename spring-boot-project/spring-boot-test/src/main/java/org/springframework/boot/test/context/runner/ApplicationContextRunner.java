...
import org.springframework.boot.actuate.autoconfigure.hazelcast.HazelcastHealthContributorAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenDisabledShouldNotCreateIndicator(HazelcastHealthContributorAutoConfigurationTests hazelcastHealthContributorAutoConfigurationTests) {
		withPropertyValues("management.health.hazelcast.enabled:false")
