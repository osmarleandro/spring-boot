...
import org.springframework.boot.actuate.autoconfigure.metrics.export.elastic.ElasticMetricsExportAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.export.elastic.ElasticMetricsExportAutoConfigurationTests.CustomConfigConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomConfigToBeUsed(ElasticMetricsExportAutoConfigurationTests elasticMetricsExportAutoConfigurationTests) {
		withUserConfiguration(CustomConfigConfiguration.class).run((context) -> assertThat(context)
