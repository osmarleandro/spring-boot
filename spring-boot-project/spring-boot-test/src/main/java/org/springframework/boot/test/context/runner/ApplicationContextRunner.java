...
import org.springframework.boot.actuate.autoconfigure.metrics.export.newrelic.NewRelicMetricsExportAutoConfigurationTests.CustomConfigConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsConfigToBeCustomized(NewRelicMetricsExportAutoConfigurationTests newRelicMetricsExportAutoConfigurationTests) {
