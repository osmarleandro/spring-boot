...
import org.springframework.boot.actuate.autoconfigure.metrics.JvmMetricsAutoConfigurationTests.CustomJvmThreadMetricsConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void allowsCustomJvmThreadMetricsToBeUsed(JvmMetricsAutoConfigurationTests jvmMetricsAutoConfigurationTests) {
