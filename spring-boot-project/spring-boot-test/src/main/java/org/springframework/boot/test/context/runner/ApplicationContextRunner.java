...
import org.springframework.boot.actuate.autoconfigure.metrics.export.statsd.StatsdMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfiguresItsConfigMeterRegistryAndMetrics(StatsdMetricsExportAutoConfigurationTests statsdMetricsExportAutoConfigurationTests) {
