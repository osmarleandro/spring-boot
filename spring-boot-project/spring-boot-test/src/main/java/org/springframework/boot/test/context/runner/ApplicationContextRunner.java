...
import org.springframework.boot.actuate.autoconfigure.metrics.export.humio.HumioMetricsExportAutoConfigurationTests.BaseConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void autoConfigurationCanBeDisabledWithDefaultsEnabledProperty(HumioMetricsExportAutoConfigurationTests humioMetricsExportAutoConfigurationTests) {
