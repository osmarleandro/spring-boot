...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void createWhenHasStatusAggregatorBeanReturnsInstanceWithAggregatorUsedForAllGroups(AutoConfiguredHealthEndpointGroupsTests autoConfiguredHealthEndpointGroupsTests) {
