...
import org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.jdbc.DataSourcePoolMetricsAutoConfigurationTests.OneHikariDataSourceConfiguration;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void hikariDataSourceIsInstrumentedWithoutMetadataProvider(DataSourcePoolMetricsAutoConfigurationTests dataSourcePoolMetricsAutoConfigurationTests) {
		withUserConfiguration(OneHikariDataSourceConfiguration.class).run((context) -> {
