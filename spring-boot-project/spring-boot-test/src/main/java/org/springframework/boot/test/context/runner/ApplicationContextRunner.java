...
import org.springframework.boot.actuate.autoconfigure.flyway.FlywayEndpointAutoConfigurationTests;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void runWhenEnabledPropertyIsFalseShouldNotHaveEndpointBean(FlywayEndpointAutoConfigurationTests flywayEndpointAutoConfigurationTests) {
		withPropertyValues("management.endpoint.flyway.enabled:false")
