...
import org.springframework.boot.actuate.autoconfigure.metrics.CompositeMeterRegistryAutoConfigurationTests;
import org.springframework.boot.actuate.autoconfigure.metrics.CompositeMeterRegistryAutoConfigurationTests.MultipleMeterRegistriesWithOnePrimaryConfig;
import org.springframework.boot.actuate.autoconfigure.metrics.CompositeMeterRegistryAutoConfigurationTests.TestMeterRegistry;
...
public class ApplicationContextRunner extends
	...
	@Test
	public
	void registerWhenHasMultipleRegistriesAndOneIsPrimaryShouldDoNothing(CompositeMeterRegistryAutoConfigurationTests compositeMeterRegistryAutoConfigurationTests) {
		withUserConfiguration(MultipleMeterRegistriesWithOnePrimaryConfig.class).run((context) -> {
