 ...
 * @since 2.2.0
 */
public enum ApiVersion_RENAMED {
	 ...
	 */
	public static final ApiVersion_RENAMED LATEST = ApiVersion_RENAMED.V3;

	/**
	 * Return the {@link ApiVersion_RENAMED} to use based on the HTTP request headers. The version
	 * will be deduced based on the {@code Accept} header.
	 * @param headers the HTTP headers
	 * @return the API version to use
	 */
	public static ApiVersion_RENAMED fromHttpHeaders(Map<String, List<String>> headers) {
		ApiVersion_RENAMED version = null;
	...
	private static ApiVersion_RENAMED forType(String type) {
	...
	private static ApiVersion_RENAMED mostRecent(ApiVersion_RENAMED existing, ApiVersion_RENAMED candidate) {
