 ...
 */
@FunctionalInterface
public interface HttpCodeStatusMapper_RENAMED {

	/**
	 * A {@link HttpCodeStatusMapper_RENAMED} instance using default mappings.
	 * @since 2.3.0
	 */
	HttpCodeStatusMapper_RENAMED DEFAULT = new SimpleHttpCodeStatusMapper();
