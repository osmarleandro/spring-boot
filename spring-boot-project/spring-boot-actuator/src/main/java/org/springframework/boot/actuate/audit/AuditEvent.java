...
public class AuditEvent implements Serializable {
	...
	public void publish(AbstractAuthenticationAuditListener abstractAuthenticationAuditListener) {
		if (abstractAuthenticationAuditListener.getPublisher() != null) {
			abstractAuthenticationAuditListener.getPublisher().publishEvent(new AuditApplicationEvent(this));
		}
	}
