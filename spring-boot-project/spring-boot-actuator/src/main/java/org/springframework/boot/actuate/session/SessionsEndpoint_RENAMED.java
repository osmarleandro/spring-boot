...
public class SessionsEndpoint_RENAMED {

	private final FindByIndexNameSessionRepository<? extends Session> sessionRepository;

	/**
	 * Create a new {@link SessionsEndpoint_RENAMED} instance.
	 * @param sessionRepository the session repository
	 */
	public SessionsEndpoint_RENAMED(FindByIndexNameSessionRepository<? extends Session> sessionRepository) {
