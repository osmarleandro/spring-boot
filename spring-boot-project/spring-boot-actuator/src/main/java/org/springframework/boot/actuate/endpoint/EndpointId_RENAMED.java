 ...
 * @since 2.0.6
 */
public final class EndpointId_RENAMED {

	private static final Log logger = LogFactory.getLog(EndpointId_RENAMED.class);
	...
	private EndpointId_RENAMED(String value) {
	...
	public boolean equals(Object obj) {
		...
		return this.lowerCaseAlphaNumeric.equals(((EndpointId_RENAMED) obj).lowerCaseAlphaNumeric);
	}
	...
	/**
	 * Factory method to create a new {@link EndpointId_RENAMED} of the specified value.
	 * @param value the endpoint ID value
	 * @return an {@link EndpointId_RENAMED} instance
	 */
	public static EndpointId_RENAMED of(String value) {
		return new EndpointId_RENAMED(value);
	}

	/**
	 * Factory method to create a new {@link EndpointId_RENAMED} of the specified value. This
	 ...
	 * @since 2.2.0
	 */
	public static EndpointId_RENAMED of(Environment environment, String value) {
		Assert.notNull(environment, "Environment must not be null");
		return new EndpointId_RENAMED(migrateLegacyId(environment, value));
	}
	...
	/**
	 * Factory method to create a new {@link EndpointId_RENAMED} from a property value. More
	 * lenient than {@link #of(String)} to allow for common "relaxed" property variants.
	 * @param value the property value to convert
	 * @return an {@link EndpointId_RENAMED} instance
	 */
	public static EndpointId_RENAMED fromPropertyValue(String value) {
		return new EndpointId_RENAMED(value.replace("-", ""));
	}
