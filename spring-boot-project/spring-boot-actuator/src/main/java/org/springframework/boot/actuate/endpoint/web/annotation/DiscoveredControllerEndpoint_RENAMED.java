 ...
 * @author Phillip Webb
 */
class DiscoveredControllerEndpoint_RENAMED extends AbstractDiscoveredEndpoint<Operation>
		implements ExposableControllerEndpoint {

	private final String rootPath;

	DiscoveredControllerEndpoint_RENAMED(EndpointDiscoverer<?, ?> discoverer, Object endpointBean, EndpointId id,
