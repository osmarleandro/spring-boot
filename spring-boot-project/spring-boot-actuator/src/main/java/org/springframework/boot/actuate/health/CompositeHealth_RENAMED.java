 ...
 * @since 2.2.0
 */
public class CompositeHealth_RENAMED extends HealthComponent {
	...
	CompositeHealth_RENAMED(ApiVersion apiVersion, Status status, Map<String, HealthComponent> components) {
