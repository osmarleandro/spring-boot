 ...
 * @since 2.0.0
 */
public class EndpointMBean_RENAMED implements DynamicMBean {

	private static final boolean REACTOR_PRESENT = ClassUtils.isPresent("reactor.core.publisher.Mono",
			EndpointMBean_RENAMED.class.getClassLoader());
	...
	EndpointMBean_RENAMED(JmxOperationResponseMapper responseMapper, ClassLoader classLoader, ExposableJmxEndpoint endpoint) {
