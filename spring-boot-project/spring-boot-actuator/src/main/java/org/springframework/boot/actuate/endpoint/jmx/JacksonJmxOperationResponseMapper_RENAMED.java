 ...
 * @since 2.0.0
 */
public class JacksonJmxOperationResponseMapper_RENAMED implements JmxOperationResponseMapper {
	...
	public JacksonJmxOperationResponseMapper_RENAMED(ObjectMapper objectMapper) {
