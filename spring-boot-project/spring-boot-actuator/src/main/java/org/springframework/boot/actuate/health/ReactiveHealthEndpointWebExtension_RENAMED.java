...
public class ReactiveHealthEndpointWebExtension_RENAMED
		extends HealthEndpointSupport<ReactiveHealthContributor, Mono<? extends HealthComponent>> {

	private static final String[] NO_PATH = {};

	/**
	 * Create a new {@link ReactiveHealthEndpointWebExtension_RENAMED} instance.
	 * @param registry the health contributor registry
	 * @param groups the health endpoint groups
	 */
	public ReactiveHealthEndpointWebExtension_RENAMED(ReactiveHealthContributorRegistry registry, HealthEndpointGroups groups) {
