 ...
 * @since 2.0.0
 */
public class RedisReactiveHealthIndicator_RENAMED extends AbstractReactiveHealthIndicator {

	private final ReactiveRedisConnectionFactory connectionFactory;

	public RedisReactiveHealthIndicator_RENAMED(ReactiveRedisConnectionFactory connectionFactory) {
