 ...
 * @since 2.0.0
 */
public class ConversionServiceParameterValueMapper_RENAMED implements ParameterValueMapper {

	private final ConversionService conversionService;

	/**
	 * Create a new {@link ConversionServiceParameterValueMapper_RENAMED} instance.
	 */
	public ConversionServiceParameterValueMapper_RENAMED() {
		this(ApplicationConversionService.getSharedInstance());
	}

	/**
	 * Create a new {@link ConversionServiceParameterValueMapper_RENAMED} instance backed by a
	 * specific conversion service.
	 * @param conversionService the conversion service
	 */
	public ConversionServiceParameterValueMapper_RENAMED(ConversionService conversionService) {
