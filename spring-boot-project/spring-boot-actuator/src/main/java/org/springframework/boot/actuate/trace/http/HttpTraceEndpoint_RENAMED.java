...
public class HttpTraceEndpoint_RENAMED {

	private final HttpTraceRepository repository;

	/**
	 * Create a new {@link HttpTraceEndpoint_RENAMED} instance.
	 * @param repository the trace repository
	 */
	public HttpTraceEndpoint_RENAMED(HttpTraceRepository repository) {
