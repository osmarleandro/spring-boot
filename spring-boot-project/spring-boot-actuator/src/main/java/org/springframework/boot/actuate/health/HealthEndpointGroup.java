...
public interface HealthEndpointGroup {
	...
	default HealthEndpointGroup get(AutoConfiguredHealthEndpointGroups autoConfiguredHealthEndpointGroups, String name) {
		return autoConfiguredHealthEndpointGroups.groups.get(name);
	}
