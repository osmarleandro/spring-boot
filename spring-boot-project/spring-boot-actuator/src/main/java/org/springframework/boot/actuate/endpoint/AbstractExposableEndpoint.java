...
public abstract class AbstractExposableEndpoint<O extends Operation> implements ExposableEndpoint<O> {
	 ...
	 */
	public AbstractExposableEndpoint(EndpointId_RENAMED id, boolean enabledByDefault, Collection<? extends O> operations) {
	...
	@Override
	public EndpointId_RENAMED getEndpointId() {
		return this.id;
	}
