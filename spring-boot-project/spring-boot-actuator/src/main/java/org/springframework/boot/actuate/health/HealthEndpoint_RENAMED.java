 ...
 */
@Endpoint(id = "health")
public class HealthEndpoint_RENAMED extends HealthEndpointSupport<HealthContributor, HealthComponent> {

	private static final String[] EMPTY_PATH = {};

	/**
	 * Create a new {@link HealthEndpoint_RENAMED} instance.
	 * @param registry the health contributor registry
	 * @param groups the health endpoint groups
	 */
	public HealthEndpoint_RENAMED(HealthContributorRegistry registry, HealthEndpointGroups groups) {
