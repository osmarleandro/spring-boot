...
public interface SecurityContext {
	...
	default boolean showDetails(AutoConfiguredHealthEndpointGroup autoConfiguredHealthEndpointGroup) {
		return autoConfiguredHealthEndpointGroup.getShowResult(this, autoConfiguredHealthEndpointGroup.showDetails);
	}
