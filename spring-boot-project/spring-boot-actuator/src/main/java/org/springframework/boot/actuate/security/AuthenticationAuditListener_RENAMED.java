 ...
 * @since 1.0.0
 */
public class AuthenticationAuditListener_RENAMED extends AbstractAuthenticationAuditListener {
	...
	private static class WebAuditListener {
		...
		void process(AuthenticationAuditListener_RENAMED listener, AbstractAuthenticationEvent input) {
			if (listener != null) {
