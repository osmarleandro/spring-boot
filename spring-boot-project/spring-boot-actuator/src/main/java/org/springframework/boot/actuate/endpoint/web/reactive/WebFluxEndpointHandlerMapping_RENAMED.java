 ...
 * @since 2.0.0
 */
public class WebFluxEndpointHandlerMapping_RENAMED extends AbstractWebFluxEndpointHandlerMapping implements InitializingBean {
	 ...
	 */
	public WebFluxEndpointHandlerMapping_RENAMED(EndpointMapping endpointMapping, Collection<ExposableWebEndpoint> endpoints,
	...
	class WebFluxLinksHandler implements LinksHandler {
		...
		public Map<String, Map<String, Link>> links(ServerWebExchange exchange) {
			...
			return Collections.singletonMap("_links",
					WebFluxEndpointHandlerMapping_RENAMED.this.linksResolver.resolveLinks(requestUri));
		}
