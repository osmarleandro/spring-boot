 ...
 * @since 2.4.0
 */
public final class Neo4jReactiveHealthIndicator_RENAMED extends AbstractReactiveHealthIndicator {

	private static final Log logger = LogFactory.getLog(Neo4jReactiveHealthIndicator_RENAMED.class);

	private final Driver driver;

	private final Neo4jHealthDetailsHandler healthDetailsHandler;

	public Neo4jReactiveHealthIndicator_RENAMED(Driver driver) {
		this.driver = driver;
