 ...
 */
@FunctionalInterface
public interface ParameterValueMapper_RENAMED {

	/**
	 * A {@link ParameterValueMapper_RENAMED} that does nothing.
	 */
	ParameterValueMapper_RENAMED NONE = (parameter, value) -> value;
