 ...
 */
class CompositeHealthContributorReactiveAdapter_RENAMED implements CompositeReactiveHealthContributor {

	private final CompositeHealthContributor delegate;

	CompositeHealthContributorReactiveAdapter_RENAMED(CompositeHealthContributor delegate) {
