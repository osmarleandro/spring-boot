 ...
 * @since 1.4.0
 */
public abstract class InfoPropertiesInfoContributor_RENAMED<T extends InfoProperties> implements InfoContributor {
	...
	protected InfoPropertiesInfoContributor_RENAMED(T properties, Mode mode) {
