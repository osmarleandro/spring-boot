 ...
 * @since 2.0.0
 */
public abstract class DiscovererEndpointFilter_RENAMED implements EndpointFilter<DiscoveredEndpoint<?>> {

	private final Class<? extends EndpointDiscoverer<?, ?>> discoverer;

	/**
	 * Create a new {@link DiscovererEndpointFilter_RENAMED} instance.
	 * @param discoverer the required discoverer
	 */
	protected DiscovererEndpointFilter_RENAMED(Class<? extends EndpointDiscoverer<?, ?>> discoverer) {
