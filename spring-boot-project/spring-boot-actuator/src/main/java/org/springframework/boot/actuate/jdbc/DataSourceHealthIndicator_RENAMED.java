 ...
 * @since 2.0.0
 */
public class DataSourceHealthIndicator_RENAMED extends AbstractHealthIndicator implements InitializingBean {
	...
	/**
	 * Create a new {@link DataSourceHealthIndicator_RENAMED} instance.
	 */
	public DataSourceHealthIndicator_RENAMED() {
		this(null, null);
	}

	/**
	 * Create a new {@link DataSourceHealthIndicator_RENAMED} using the specified
	 * {@link DataSource}.
	 * @param dataSource the data source
	 */
	public DataSourceHealthIndicator_RENAMED(DataSource dataSource) {
	 ...
	 */
	public DataSourceHealthIndicator_RENAMED(DataSource dataSource, String query) {
