 ...
 * @since 2.0.0
 */
public class EndpointMediaTypes_RENAMED {

	private static final String JSON_MEDIA_TYPE = "application/json";

	/**
	 * Default {@link EndpointMediaTypes_RENAMED} for this version of Spring Boot.
	 */
	public static final EndpointMediaTypes_RENAMED DEFAULT = new EndpointMediaTypes_RENAMED(ActuatorMediaType.V3_JSON,
	...
	/**
	 * Creates a new {@link EndpointMediaTypes_RENAMED} with the given {@code produced} and
	 ...
	 * @since 2.2.0
	 */
	public EndpointMediaTypes_RENAMED(String... producedAndConsumed) {
	 ...
	 * @since 2.2.0
	 */
	public EndpointMediaTypes_RENAMED(List<String> producedAndConsumed) {
	 ...
	 */
	public EndpointMediaTypes_RENAMED(List<String> produced, List<String> consumed) {
