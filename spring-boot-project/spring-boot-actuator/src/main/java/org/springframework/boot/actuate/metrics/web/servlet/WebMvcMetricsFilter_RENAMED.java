 ...
 * @since 2.0.0
 */
public class WebMvcMetricsFilter_RENAMED extends OncePerRequestFilter {
	...
	/**
	 * Create a new {@link WebMvcMetricsFilter_RENAMED} instance.
	 ...
	 * @since 2.2.0
	 */
	public WebMvcMetricsFilter_RENAMED(MeterRegistry registry, WebMvcTagsProvider tagsProvider, String metricName,
			AutoTimer autoTimer) {
