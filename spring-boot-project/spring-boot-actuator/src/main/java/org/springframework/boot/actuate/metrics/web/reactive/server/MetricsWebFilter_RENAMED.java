...
public class MetricsWebFilter_RENAMED implements WebFilter {
	 ...
	 * @since 2.2.0
	 */
	public MetricsWebFilter_RENAMED(MeterRegistry registry, WebFluxTagsProvider tagsProvider, String metricName,
			AutoTimer autoTimer) {
