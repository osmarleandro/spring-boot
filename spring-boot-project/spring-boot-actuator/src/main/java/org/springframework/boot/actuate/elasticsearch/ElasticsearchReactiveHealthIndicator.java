...
public class ElasticsearchReactiveHealthIndicator extends AbstractReactiveHealthIndicator {
	...
	public static final ParameterizedTypeReference<Map<String, Object>> STRING_OBJECT_MAP = new ParameterizedTypeReference<Map<String, Object>>() {
	};
	...
	private Mono<Health> getHealth(Health.Builder builder, WebClient webClient) {
		return webClient.get().uri("/_cluster/health/").exchangeToMono((response) -> builder.doHealthCheck(this, response));
	}

	public Health getHealth(Health.Builder builder, Map<String, Object> body) {
