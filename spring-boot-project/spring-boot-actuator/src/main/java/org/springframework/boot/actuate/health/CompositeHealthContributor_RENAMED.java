 ...
 */
public interface CompositeHealthContributor_RENAMED extends HealthContributor, NamedContributors<HealthContributor> {

	/**
	 * Factory method that will create a {@link CompositeHealthContributor_RENAMED} from the
	 * specified map.
	 * @param map the source map
	 * @return a composite health contributor instance
	 */
	static CompositeHealthContributor_RENAMED fromMap(Map<String, ? extends HealthContributor> map) {
	 ...
	 * @return a composite health contributor instance
	 */
	static <V> CompositeHealthContributor_RENAMED fromMap(Map<String, V> map,
