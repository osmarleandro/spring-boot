 ...
 * @since 2.0.0
 */
public class JmxEndpointExporter_RENAMED implements InitializingBean, DisposableBean, BeanClassLoaderAware {

	private static final Log logger = LogFactory.getLog(JmxEndpointExporter_RENAMED.class);
	...
	public JmxEndpointExporter_RENAMED(MBeanServer mBeanServer, EndpointObjectNameFactory objectNameFactory,
