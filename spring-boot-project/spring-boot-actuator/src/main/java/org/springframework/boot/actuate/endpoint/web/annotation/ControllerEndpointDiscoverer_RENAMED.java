 ...
 * @since 2.0.0
 */
public class ControllerEndpointDiscoverer_RENAMED extends EndpointDiscoverer<ExposableControllerEndpoint, Operation>
		implements ControllerEndpointsSupplier {

	private final List<PathMapper> endpointPathMappers;

	/**
	 * Create a new {@link ControllerEndpointDiscoverer_RENAMED} instance.
	 * @param applicationContext the source application context
	 * @param endpointPathMappers the endpoint path mappers
	 * @param filters filters to apply
	 */
	public ControllerEndpointDiscoverer_RENAMED(ApplicationContext applicationContext, List<PathMapper> endpointPathMappers,
