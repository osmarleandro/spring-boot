 ...
 * @since 2.0.0
 */
public final class WebEndpointResponse_RENAMED<T> {
	 ...
	 */
	public WebEndpointResponse_RENAMED() {
		this(null);
	}
	 ...
	 */
	public WebEndpointResponse_RENAMED(int status) {
		this(null, status);
	}
	 ...
	 * @param body the body
	 */
	public WebEndpointResponse_RENAMED(T body) {
		this(body, STATUS_OK);
	}
	 ...
	 * @param status the HTTP status
	 */
	public WebEndpointResponse_RENAMED(T body, int status) {
		this.body = body;
		this.status = status;
	}
