 ...
 * @since 2.0.0
 */
public abstract class AbstractDiscoveredOperation_RENAMED implements Operation {
	...
	/**
	 * Create a new {@link AbstractDiscoveredOperation_RENAMED} instance.
	 * @param operationMethod the method backing the operation
	 * @param invoker the operation invoker to use
	 */
	public AbstractDiscoveredOperation_RENAMED(DiscoveredOperationMethod operationMethod, OperationInvoker invoker) {
