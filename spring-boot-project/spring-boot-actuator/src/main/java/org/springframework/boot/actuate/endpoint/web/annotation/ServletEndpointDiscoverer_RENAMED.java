 ...
 * @since 2.0.0
 */
public class ServletEndpointDiscoverer_RENAMED extends EndpointDiscoverer<ExposableServletEndpoint, Operation>
		implements ServletEndpointsSupplier {

	private final List<PathMapper> endpointPathMappers;

	/**
	 * Create a new {@link ServletEndpointDiscoverer_RENAMED} instance.
	 * @param applicationContext the source application context
	 * @param endpointPathMappers the endpoint path mappers
	 * @param filters filters to apply
	 */
	public ServletEndpointDiscoverer_RENAMED(ApplicationContext applicationContext, List<PathMapper> endpointPathMappers,
