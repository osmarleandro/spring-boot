 ...
 * @author Phillip Webb
 */
class OperationMethodParameter_RENAMED implements OperationParameter {
	...
	/**
	 * Create a new {@link OperationMethodParameter_RENAMED} instance.
	 * @param name the parameter name
	 * @param parameter the parameter
	 */
	OperationMethodParameter_RENAMED(String name, Parameter parameter) {
		this.name = name;
