 ...
 * @since 2.4.0
 */
public class CassandraDriverReactiveHealthIndicator_RENAMED extends AbstractReactiveHealthIndicator {
	 ...
	 */
	public CassandraDriverReactiveHealthIndicator_RENAMED(CqlSession session) {
