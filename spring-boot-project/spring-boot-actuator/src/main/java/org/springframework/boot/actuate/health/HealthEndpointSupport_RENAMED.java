 ...
 */
abstract class HealthEndpointSupport_RENAMED<C, T> {
	...
	/**
	 * Create a new {@link HealthEndpointSupport_RENAMED} instance.
	 * @param registry the health contributor registry
	 * @param groups the health endpoint groups
	 */
	HealthEndpointSupport_RENAMED(ContributorRegistry<C> registry, HealthEndpointGroups groups) {
