 ...
 * @since 2.0.7
 */
public class LongTaskTimingHandlerInterceptor_RENAMED implements HandlerInterceptor {
	 ...
	 */
	public LongTaskTimingHandlerInterceptor_RENAMED(MeterRegistry registry, WebMvcTagsProvider tagsProvider) {
