 ...
 * @since 2.3.0
 */
public class ConnectionPoolMetrics_RENAMED implements MeterBinder {
	...
	public ConnectionPoolMetrics_RENAMED(ConnectionPool pool, String name, Iterable<Tag> tags) {
		this.pool = pool;
