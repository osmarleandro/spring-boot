 ...
 * @author Phillip Webb
 */
class MetricsClientHttpRequestInterceptor_RENAMED implements ClientHttpRequestInterceptor {
	 ...
	 * @since 2.2.0
	 */
	MetricsClientHttpRequestInterceptor_RENAMED(MeterRegistry meterRegistry, RestTemplateExchangeTagsProvider tagProvider,
