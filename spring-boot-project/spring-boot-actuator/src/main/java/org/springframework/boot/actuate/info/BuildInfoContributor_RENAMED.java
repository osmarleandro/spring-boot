 ...
 * @since 1.4.0
 */
public class BuildInfoContributor_RENAMED extends InfoPropertiesInfoContributor<BuildProperties> {

	public BuildInfoContributor_RENAMED(BuildProperties properties) {
