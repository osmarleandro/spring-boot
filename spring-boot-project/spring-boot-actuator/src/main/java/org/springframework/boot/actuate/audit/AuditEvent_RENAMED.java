...
public class AuditEvent_RENAMED implements Serializable {
	 ...
	 */
	public AuditEvent_RENAMED(String principal, String type, Map<String, Object> data) {
	 ...
	 */
	public AuditEvent_RENAMED(String principal, String type, String... data) {
	 ...
	 * @param data the event data
	 */
	public AuditEvent_RENAMED(Instant timestamp, String principal, String type, Map<String, Object> data) {
