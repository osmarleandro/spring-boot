 ...
 * @since 2.0.0
 */
public abstract class AbstractReactiveHealthIndicator_RENAMED implements ReactiveHealthIndicator {
	...
	/**
	 * Create a new {@link AbstractReactiveHealthIndicator_RENAMED} instance with a default
	 * {@code healthCheckFailedMessage}.
	 * @since 2.1.7
	 */
	protected AbstractReactiveHealthIndicator_RENAMED() {
		this(NO_MESSAGE);
	}

	/**
	 * Create a new {@link AbstractReactiveHealthIndicator_RENAMED} instance with a specific
	 * message to log when the health check fails.
	 * @param healthCheckFailedMessage the message to log on health check failure
	 * @since 2.1.7
	 */
	protected AbstractReactiveHealthIndicator_RENAMED(String healthCheckFailedMessage) {
	 ...
	 * @since 2.1.7
	 */
	protected AbstractReactiveHealthIndicator_RENAMED(Function<Throwable, String> healthCheckFailedMessage) {
