 ...
 * @since 2.0.0
 */
public class IsoOffsetDateTimeConverter_RENAMED implements Converter<String, OffsetDateTime> {
	...
	public static void registerConverter(ConverterRegistry registry) {
		registry.addConverter(new IsoOffsetDateTimeConverter_RENAMED());
	}
