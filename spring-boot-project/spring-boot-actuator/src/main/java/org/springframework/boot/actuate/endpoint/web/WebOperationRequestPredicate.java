...
public final class WebOperationRequestPredicate {
	...
	private final WebEndpointHttpMethod_RENAMED httpMethod;
	 ...
	 */
	public WebOperationRequestPredicate(String path, WebEndpointHttpMethod_RENAMED httpMethod, Collection<String> consumes,
	 ...
	 */
	public WebEndpointHttpMethod_RENAMED getHttpMethod() {
