 ...
 * @since 2.3.2
 */
public class ElasticsearchReactiveHealthIndicator_RENAMED extends AbstractReactiveHealthIndicator {
	...
	public ElasticsearchReactiveHealthIndicator_RENAMED(ReactiveElasticsearchClient client) {
