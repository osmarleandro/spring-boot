 ...
 * @author Phillip Webb
 */
class DiscoveredWebOperation_RENAMED extends AbstractDiscoveredOperation implements WebOperation {

	private static final boolean REACTIVE_STREAMS_PRESENT = ClassUtils.isPresent("org.reactivestreams.Publisher",
			DiscoveredWebOperation_RENAMED.class.getClassLoader());
	...
	DiscoveredWebOperation_RENAMED(EndpointId endpointId, DiscoveredOperationMethod operationMethod, OperationInvoker invoker,
