 ...
 * @since 2.2.0
 */
public class SimpleHttpCodeStatusMapper_RENAMED implements HttpCodeStatusMapper {
	...
	/**
	 * Create a new {@link SimpleHttpCodeStatusMapper_RENAMED} instance using default mappings.
	 */
	public SimpleHttpCodeStatusMapper_RENAMED() {
		this(null);
	}

	/**
	 * Create a new {@link SimpleHttpCodeStatusMapper_RENAMED} with the specified mappings.
	 * @param mappings the mappings to use or {@code null} to use the default mappings
	 */
	public SimpleHttpCodeStatusMapper_RENAMED(Map<String, Integer> mappings) {
