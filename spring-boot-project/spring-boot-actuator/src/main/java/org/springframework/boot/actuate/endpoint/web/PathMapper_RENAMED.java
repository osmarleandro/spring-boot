 ...
 */
@FunctionalInterface
public interface PathMapper_RENAMED {
	 ...
	 */
	static String getRootPath(List<PathMapper_RENAMED> pathMappers, EndpointId endpointId) {
		Assert.notNull(endpointId, "EndpointId must not be null");
		if (pathMappers != null) {
			for (PathMapper_RENAMED mapper : pathMappers) {
