 ...
 * @since 2.0.0
 */
public class DiskSpaceHealthIndicator_RENAMED extends AbstractHealthIndicator {

	private static final Log logger = LogFactory.getLog(DiskSpaceHealthIndicator_RENAMED.class);
	 ...
	 */
	public DiskSpaceHealthIndicator_RENAMED(File path, DataSize threshold) {
