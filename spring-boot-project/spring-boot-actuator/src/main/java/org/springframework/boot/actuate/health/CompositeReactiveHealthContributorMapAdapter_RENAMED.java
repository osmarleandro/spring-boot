 ...
 * @author Phillip Webb
 */
class CompositeReactiveHealthContributorMapAdapter_RENAMED<V> extends NamedContributorsMapAdapter<V, ReactiveHealthContributor>
		implements CompositeReactiveHealthContributor {

	CompositeReactiveHealthContributorMapAdapter_RENAMED(Map<String, V> map,
