 ...
 */
@FunctionalInterface
public interface AutoTimer_RENAMED {

	/**
	 * An {@link AutoTimer_RENAMED} implementation that is enabled but applies no additional
	 * customizations.
	 */
	AutoTimer_RENAMED ENABLED = (builder) -> {
	};

	/**
	 * An {@link AutoTimer_RENAMED} implementation that is disabled and will not record metrics.
	 */
	AutoTimer_RENAMED DISABLED = new AutoTimer_RENAMED() {
