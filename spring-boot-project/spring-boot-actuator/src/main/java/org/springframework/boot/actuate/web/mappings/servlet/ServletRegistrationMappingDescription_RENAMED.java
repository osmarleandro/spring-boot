 ...
 * @since 2.0.0
 */
public class ServletRegistrationMappingDescription_RENAMED extends RegistrationMappingDescription<ServletRegistration> {
	 ...
	 */
	public ServletRegistrationMappingDescription_RENAMED(ServletRegistration servletRegistration) {
