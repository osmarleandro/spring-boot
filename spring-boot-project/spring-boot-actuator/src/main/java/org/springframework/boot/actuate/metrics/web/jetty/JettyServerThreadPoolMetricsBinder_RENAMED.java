 ...
 * @since 2.1.0
 */
public class JettyServerThreadPoolMetricsBinder_RENAMED implements ApplicationListener<ApplicationStartedEvent> {

	private final MeterRegistry meterRegistry;

	private final Iterable<Tag> tags;

	public JettyServerThreadPoolMetricsBinder_RENAMED(MeterRegistry meterRegistry) {
		this(meterRegistry, Collections.emptyList());
	}

	public JettyServerThreadPoolMetricsBinder_RENAMED(MeterRegistry meterRegistry, Iterable<Tag> tags) {
