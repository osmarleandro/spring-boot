 ...
 * @since 2.0.0
 */
public class DiscoveredOperationMethod_RENAMED extends OperationMethod {

	private final List<String> producesMediaTypes;

	public DiscoveredOperationMethod_RENAMED(Method method, OperationType operationType,
