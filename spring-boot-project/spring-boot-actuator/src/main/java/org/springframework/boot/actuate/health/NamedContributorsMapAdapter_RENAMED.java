 ...
 */
abstract class NamedContributorsMapAdapter_RENAMED<V, C> implements NamedContributors<C> {

	private final Map<String, V> map;

	private final Function<V, ? extends C> valueAdapter;

	NamedContributorsMapAdapter_RENAMED(Map<String, V> map, Function<V, ? extends C> valueAdapter) {
