 ...
 * @since 2.0.0
 */
public class FilterRegistrationMappingDescription_RENAMED extends RegistrationMappingDescription<FilterRegistration> {
	 ...
	 */
	public FilterRegistrationMappingDescription_RENAMED(FilterRegistration filterRegistration) {
