 ...
 * @since 2.0.0
 */
public class CacheMetricsRegistrar_RENAMED {
	 ...
	 */
	public CacheMetricsRegistrar_RENAMED(MeterRegistry registry, Collection<CacheMeterBinderProvider<?>> binderProviders) {
	...
	private MeterBinder getMeterBinder(Cache cache, Tags tags) {
		...
		return LambdaSafe.callbacks(CacheMeterBinderProvider.class, this.binderProviders, cache)
				.withLogger(CacheMetricsRegistrar_RENAMED.class)
