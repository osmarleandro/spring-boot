 ...
 * @since 2.1.0
 */
public class NonUniqueCacheException_RENAMED extends RuntimeException {

	private final String cacheName;

	private final Collection<String> cacheManagerNames;

	public NonUniqueCacheException_RENAMED(String cacheName, Collection<String> cacheManagerNames) {
