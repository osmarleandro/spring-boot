...
public class CachesEndpointWebExtension {
	...
	@ReadOperation
	public IWebEndpointResponse<CacheEntry> cache(@Selector String cache, @Nullable String cacheManager) {
		try {
	...
	@DeleteOperation
	public IWebEndpointResponse<Void> clearCache(@Selector String cache, @Nullable String cacheManager) {
		try {
