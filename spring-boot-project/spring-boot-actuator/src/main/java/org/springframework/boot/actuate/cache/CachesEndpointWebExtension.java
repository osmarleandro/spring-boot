...
public class CachesEndpointWebExtension {
	...
	@ReadOperation
	public WebEndpointResponse<CacheEntry> cache(@Selector_RENAMED String cache, @Nullable String cacheManager) {
		try {
	...
	@DeleteOperation
	public WebEndpointResponse<Void> clearCache(@Selector_RENAMED String cache, @Nullable String cacheManager) {
		try {
