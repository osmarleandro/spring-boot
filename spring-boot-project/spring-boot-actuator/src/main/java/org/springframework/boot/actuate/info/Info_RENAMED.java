...
public final class Info_RENAMED {

	private final Map<String, Object> details;

	private Info_RENAMED(Builder builder) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Info_RENAMED) {
			Info_RENAMED other = (Info_RENAMED) obj;
	...
	/**
	 * Builder for creating immutable {@link Info_RENAMED} instances.
	 */
	public static class Builder {
		...
		/**
		 * Create a new {@link Info_RENAMED} instance based on the state of this builder.
		 * @return a new {@link Info_RENAMED} instance
		 */
		public Info_RENAMED build() {
			return new Info_RENAMED(this);
		}
