 ...
 * @since 2.0.0
 */
public final class MissingParametersException_RENAMED extends InvalidEndpointRequestException {

	private final Set<OperationParameter> missingParameters;

	public MissingParametersException_RENAMED(Set<OperationParameter> missingParameters) {
