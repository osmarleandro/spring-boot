 ...
 * @since 2.0.0
 */
public interface DiscoveredEndpoint_RENAMED<O extends Operation> extends ExposableEndpoint<O> {
	...
	/**
	 * Return the source bean that was used to construct the {@link DiscoveredEndpoint_RENAMED}.
