...
/**
 * A discovered {@link ExposableJmxEndpoint_RENAMED JMX endpoint}.
 *
 * @author Phillip Webb
 */
class DiscoveredJmxEndpoint extends AbstractDiscoveredEndpoint<JmxOperation> implements ExposableJmxEndpoint_RENAMED {
