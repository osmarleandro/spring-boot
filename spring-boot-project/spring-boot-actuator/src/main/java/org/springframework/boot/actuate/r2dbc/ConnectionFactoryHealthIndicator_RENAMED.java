 ...
 * @since 2.3.0
 */
public class ConnectionFactoryHealthIndicator_RENAMED extends AbstractReactiveHealthIndicator {
	...
	/**
	 * Create a new {@link ConnectionFactoryHealthIndicator_RENAMED} using the specified
	 * {@link ConnectionFactory} and no validation query.
	 * @param connectionFactory the connection factory
	 * @see Connection#validate(ValidationDepth)
	 */
	public ConnectionFactoryHealthIndicator_RENAMED(ConnectionFactory connectionFactory) {
	 ...
	 * validation
	 */
	public ConnectionFactoryHealthIndicator_RENAMED(ConnectionFactory connectionFactory, String validationQuery) {
