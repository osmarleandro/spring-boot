 ...
 * @since 2.0.0
 */
public class DefaultWebFluxTagsProvider_RENAMED implements WebFluxTagsProvider {

	private final boolean ignoreTrailingSlash;

	private final List<WebFluxTagsContributor> contributors;

	public DefaultWebFluxTagsProvider_RENAMED() {
		this(false);
	}

	/**
	 * Creates a new {@link DefaultWebFluxTagsProvider_RENAMED} that will provide tags from the
	 * given {@code contributors} in addition to its own.
	 * @param contributors the contributors that will provide additional tags
	 * @since 2.3.0
	 */
	public DefaultWebFluxTagsProvider_RENAMED(List<WebFluxTagsContributor> contributors) {
		this(false, contributors);
	}

	public DefaultWebFluxTagsProvider_RENAMED(boolean ignoreTrailingSlash) {
	 ...
	 * @since 2.3.0
	 */
	public DefaultWebFluxTagsProvider_RENAMED(boolean ignoreTrailingSlash, List<WebFluxTagsContributor> contributors) {
