...
public interface HealthEndpointGroups {
	...
	@Test
	default
	void containsAllWhenContainsOneReturnFalse(AvailabilityProbesHealthEndpointGroupsTests availabilityProbesHealthEndpointGroupsTests) {
		given(getNames()).willReturn(new LinkedHashSet<>(Arrays.asList("test", "liveness")));
		assertThat(AvailabilityProbesHealthEndpointGroups.containsAllProbeGroups(this)).isFalse();
	}
