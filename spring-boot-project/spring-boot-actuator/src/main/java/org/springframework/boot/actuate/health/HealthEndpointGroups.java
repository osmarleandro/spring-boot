...
public interface HealthEndpointGroups {
	...
	@Test
	default
	void getPrimaryDelegatesToGroups(AvailabilityProbesHealthEndpointGroupsTests availabilityProbesHealthEndpointGroupsTests) {
		given(getPrimary()).willReturn(availabilityProbesHealthEndpointGroupsTests.group);
		HealthEndpointGroups availabilityProbes = new AvailabilityProbesHealthEndpointGroups(this);
		assertThat(availabilityProbes.getPrimary()).isEqualTo(availabilityProbesHealthEndpointGroupsTests.group);
	}
