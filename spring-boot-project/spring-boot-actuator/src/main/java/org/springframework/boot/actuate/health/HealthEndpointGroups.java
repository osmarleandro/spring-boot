...
public interface HealthEndpointGroups {
	...
	default HealthEndpointGroups postProcessHealthEndpointGroups() {
		if (AvailabilityProbesHealthEndpointGroups.containsAllProbeGroups(this)) {
			return this;
		}
		return new AvailabilityProbesHealthEndpointGroups(this);
	}
