 ...
 * @since 2.0.0
 */
public class EndpointLinksResolver_RENAMED {

	private static final Log logger = LogFactory.getLog(EndpointLinksResolver_RENAMED.class);
	 ...
	 */
	public EndpointLinksResolver_RENAMED(Collection<? extends ExposableEndpoint<?>> endpoints) {
	 ...
	 */
	public EndpointLinksResolver_RENAMED(Collection<? extends ExposableEndpoint<?>> endpoints, String basePath) {
		this.endpoints = endpoints;
