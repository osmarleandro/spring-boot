...
public class LogFileWebEndpoint_RENAMED {

	private static final Log logger = LogFactory.getLog(LogFileWebEndpoint_RENAMED.class);

	private File externalFile;

	private final LogFile logFile;

	public LogFileWebEndpoint_RENAMED(LogFile logFile, File externalFile) {
