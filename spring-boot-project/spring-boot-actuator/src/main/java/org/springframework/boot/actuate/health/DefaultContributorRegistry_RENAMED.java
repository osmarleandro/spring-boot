 ...
 */
class DefaultContributorRegistry_RENAMED<C> implements ContributorRegistry<C> {
	...
	DefaultContributorRegistry_RENAMED() {
		this(Collections.emptyMap());
	}

	DefaultContributorRegistry_RENAMED(Map<String, C> contributors) {
		this(contributors, HealthContributorNameFactory.INSTANCE);
	}

	DefaultContributorRegistry_RENAMED(Map<String, C> contributors, Function<String, String> nameFactory) {
