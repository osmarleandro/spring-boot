 ...
 * @since 2.0.0
 */
public class WebMvcEndpointHandlerMapping_RENAMED extends AbstractWebMvcEndpointHandlerMapping {
	 ...
	 */
	public WebMvcEndpointHandlerMapping_RENAMED(EndpointMapping endpointMapping, Collection<ExposableWebEndpoint> endpoints,
	...
	class WebMvcLinksHandler implements LinksHandler {
		...
		public Map<String, Map<String, Link>> links(HttpServletRequest request, HttpServletResponse response) {
			return Collections.singletonMap("_links",
					WebMvcEndpointHandlerMapping_RENAMED.this.linksResolver.resolveLinks(request.getRequestURL().toString()));
		}
