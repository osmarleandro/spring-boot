 ...
 */
public interface CompositeReactiveHealthContributor_RENAMED
		extends ReactiveHealthContributor, NamedContributors<ReactiveHealthContributor> {

	/**
	 * Factory method that will create a {@link CompositeReactiveHealthContributor_RENAMED} from
	 * the specified map.
	 * @param map the source map
	 * @return a composite health contributor instance
	 */
	static CompositeReactiveHealthContributor_RENAMED fromMap(Map<String, ? extends ReactiveHealthContributor> map) {
	 ...
	 * @return a composite health contributor instance
	 */
	static <V> CompositeReactiveHealthContributor_RENAMED fromMap(Map<String, V> map,
