 ...
 * @since 2.2.0
 */
public interface HealthEndpointGroups_RENAMED {
	...
	/**
	 * Factory method to create a {@link HealthEndpointGroups_RENAMED} instance.
	 * @param primary the primary group
	 * @param additional the additional groups
	 * @return a new {@link HealthEndpointGroups_RENAMED} instance
	 */
	static HealthEndpointGroups_RENAMED of(HealthEndpointGroup primary, Map<String, HealthEndpointGroup> additional) {
		Assert.notNull(primary, "Primary must not be null");
		Assert.notNull(additional, "Additional must not be null");
		return new HealthEndpointGroups_RENAMED() {
