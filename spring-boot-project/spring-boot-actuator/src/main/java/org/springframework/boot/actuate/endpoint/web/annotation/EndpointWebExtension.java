...
/**
 * Identifies a type as being a Web-specific extension of an {@link Endpoint_RENAMED @Endpoint}.
 *
...
public @interface EndpointWebExtension {
	...
	/**
	 * The {@link Endpoint_RENAMED endpoint} class to which this Web extension relates.
