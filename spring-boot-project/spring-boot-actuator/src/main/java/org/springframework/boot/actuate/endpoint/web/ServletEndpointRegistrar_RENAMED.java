 ...
 * @since 2.0.0
 */
public class ServletEndpointRegistrar_RENAMED implements ServletContextInitializer {

	private static final Log logger = LogFactory.getLog(ServletEndpointRegistrar_RENAMED.class);

	private final String basePath;

	private final Collection<ExposableServletEndpoint> servletEndpoints;

	public ServletEndpointRegistrar_RENAMED(String basePath, Collection<ExposableServletEndpoint> servletEndpoints) {
