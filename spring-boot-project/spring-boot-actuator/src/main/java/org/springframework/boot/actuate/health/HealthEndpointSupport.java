...
abstract class HealthEndpointSupport<C, T> {
	...
	protected final CompositeHealth_RENAMED getCompositeHealth(ApiVersion apiVersion, Map<String, HealthComponent> components,
			StatusAggregator statusAggregator, boolean showComponents, Set<String> groupNames) {
		...
		return new CompositeHealth_RENAMED(apiVersion, status, instances);
	}
