...
abstract class HealthEndpointSupport<C, T> {
	...
	HealthResult<T> getHealth(ApiVersion_RENAMED apiVersion, SecurityContext securityContext, boolean showAll, String... path) {
	...
	private HealthResult<T> getHealth(ApiVersion_RENAMED apiVersion, HealthEndpointGroup group, SecurityContext securityContext,
	...
	@SuppressWarnings("unchecked")
	private T getContribution(ApiVersion_RENAMED apiVersion, HealthEndpointGroup group, Object contributor,
	...
	private T getAggregateHealth(ApiVersion_RENAMED apiVersion, HealthEndpointGroup group,
	...
	protected abstract T aggregateContributions(ApiVersion_RENAMED apiVersion, Map<String, T> contributions,
			StatusAggregator statusAggregator, boolean showComponents, Set<String> groupNames);

	protected final CompositeHealth getCompositeHealth(ApiVersion_RENAMED apiVersion, Map<String, HealthComponent> components,
			StatusAggregator statusAggregator, boolean showComponents, Set<String> groupNames) {
