 ...
 */
@FunctionalInterface
public interface StatusAggregator_RENAMED {

	/**
	 * Return {@link StatusAggregator_RENAMED} instance using default ordering rules.
	 * @return a {@code StatusAggregator} with default ordering rules.
	 * @since 2.3.0
	 */
	static StatusAggregator_RENAMED getDefault() {
