 ...
 * @since 2.3.0
 */
public class ReadinessStateHealthIndicator_RENAMED extends AvailabilityStateHealthIndicator {

	public ReadinessStateHealthIndicator_RENAMED(ApplicationAvailability availability) {
