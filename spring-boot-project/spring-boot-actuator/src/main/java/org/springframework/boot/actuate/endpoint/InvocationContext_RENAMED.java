 ...
 * @since 2.0.0
 */
public class InvocationContext_RENAMED {
	 ...
	 */
	public InvocationContext_RENAMED(SecurityContext securityContext, Map<String, Object> arguments) {
	 ...
	 * @since 2.2.0
	 */
	public InvocationContext_RENAMED(ApiVersion apiVersion, SecurityContext securityContext, Map<String, Object> arguments) {
