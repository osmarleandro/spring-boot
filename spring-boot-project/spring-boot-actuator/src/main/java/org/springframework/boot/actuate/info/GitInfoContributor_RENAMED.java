 ...
 * @since 1.4.0
 */
public class GitInfoContributor_RENAMED extends InfoPropertiesInfoContributor<GitProperties> {

	public GitInfoContributor_RENAMED(GitProperties properties) {
		this(properties, Mode.SIMPLE);
	}

	public GitInfoContributor_RENAMED(GitProperties properties, Mode mode) {
