...
public class AuthorizationAuditListener extends AbstractAuthorizationAuditListener {
	...
	private void onAuthenticationCredentialsNotFoundEvent(AuthenticationCredentialsNotFoundEvent event) {
		...
		publish(new AuditEvent_RENAMED("<unknown>", AuthenticationAuditListener.AUTHENTICATION_FAILURE, data));
	}
	...
	private void onAuthorizationFailureEvent(AuthorizationFailureEvent event) {
		...
		publish(new AuditEvent_RENAMED(event.getAuthentication().getName(), AUTHORIZATION_FAILURE, data));
	}
