 ...
 * @since 2.1.1
 */
public class ElasticsearchRestHealthIndicator_RENAMED extends AbstractHealthIndicator {
	...
	public ElasticsearchRestHealthIndicator_RENAMED(RestHighLevelClient client) {
		this(client.getLowLevelClient());
	}

	public ElasticsearchRestHealthIndicator_RENAMED(RestClient client) {
