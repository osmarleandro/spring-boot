...
public enum ApiVersion {
	...
	@ReadOperation
	public Mono<WebEndpointResponse<? extends HealthComponent>> health(ReactiveHealthEndpointWebExtension reactiveHealthEndpointWebExtension, SecurityContext securityContext, String... path) {
		return reactiveHealthEndpointWebExtension.health(this, securityContext, false, path);
	}
