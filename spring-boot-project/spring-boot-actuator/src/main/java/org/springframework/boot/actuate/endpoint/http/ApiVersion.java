...
public enum ApiVersion {
	...
	@ReadOperation
	public WebEndpointResponse<HealthComponent> health(HealthEndpointWebExtension healthEndpointWebExtension, SecurityContext securityContext) {
		return healthEndpointWebExtension.health(this, securityContext, false, HealthEndpointWebExtension.NO_PATH);
	}
