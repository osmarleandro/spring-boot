...
public enum ApiVersion {
	...
	@ReadOperation
	public Mono<WebEndpointResponse<? extends HealthComponent>> health(CloudFoundryReactiveHealthEndpointWebExtension cloudFoundryReactiveHealthEndpointWebExtension) {
		return cloudFoundryReactiveHealthEndpointWebExtension.delegate.health(this, SecurityContext.NONE, true);
	}
