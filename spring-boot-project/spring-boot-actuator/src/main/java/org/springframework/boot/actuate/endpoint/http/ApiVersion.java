...
public enum ApiVersion {
	...
	public HealthComponent health(HealthEndpoint healthEndpoint, String... path) {
		HealthResult<HealthComponent> result = healthEndpoint.getHealth(this, SecurityContext.NONE, true, path);
