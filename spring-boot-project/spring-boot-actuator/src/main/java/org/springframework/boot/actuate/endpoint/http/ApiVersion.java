...
public enum ApiVersion {
	...
	@ReadOperation
	public WebEndpointResponse<HealthComponent> health(CloudFoundryHealthEndpointWebExtension cloudFoundryHealthEndpointWebExtension, String... path) {
		return cloudFoundryHealthEndpointWebExtension.delegate.health(this, SecurityContext.NONE, true, path);
	}
