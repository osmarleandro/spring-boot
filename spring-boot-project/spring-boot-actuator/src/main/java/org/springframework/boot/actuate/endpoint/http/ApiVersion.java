...
public enum ApiVersion {
	...
	public HealthComponent aggregateContributions(HealthEndpoint healthEndpoint, Map<String, HealthComponent> contributions, StatusAggregator statusAggregator, boolean showComponents, Set<String> groupNames) {
		return healthEndpoint.getCompositeHealth(this, contributions, statusAggregator, showComponents, groupNames);
	}
