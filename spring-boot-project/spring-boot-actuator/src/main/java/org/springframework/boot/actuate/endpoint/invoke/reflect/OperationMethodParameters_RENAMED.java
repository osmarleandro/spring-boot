 ...
 * @author Phillip Webb
 */
class OperationMethodParameters_RENAMED implements OperationParameters {

	private final List<OperationParameter> operationParameters;

	/**
	 * Create a new {@link OperationMethodParameters_RENAMED} instance.
	 * @param method the source method
	 * @param parameterNameDiscoverer the parameter name discoverer
	 */
	OperationMethodParameters_RENAMED(Method method, ParameterNameDiscoverer parameterNameDiscoverer) {
