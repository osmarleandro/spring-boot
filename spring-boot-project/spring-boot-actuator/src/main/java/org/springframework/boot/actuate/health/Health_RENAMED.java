 ...
 * <p>
 * {@link Health_RENAMED} instances can be created by using {@link Builder}'s fluent API. Typical
...
public final class Health_RENAMED extends HealthComponent {
	...
	/**
	 * Create a new {@link Health_RENAMED} instance with the specified status and details.
	 * @param builder the Builder to use
	 */
	private Health_RENAMED(Builder builder) {
		Assert.notNull(builder, "Builder must not be null");
		this.status = builder.status;
		this.details = Collections.unmodifiableMap(builder.details);
	}

	Health_RENAMED(Status status, Map<String, Object> details) {
		this.status = status;
	...
	/**
	 * Return a new instance of this {@link Health_RENAMED} with all {@link #getDetails() details}
	 * removed.
	 * @return a new instance without details
	 * @since 2.2.0
	 */
	Health_RENAMED withoutDetails() {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof Health_RENAMED) {
			Health_RENAMED other = (Health_RENAMED) obj;
	...
	/**
	 * Builder for creating immutable {@link Health_RENAMED} instances.
	 */
	public static class Builder {
		...
		/**
		 * Create a new {@link Health_RENAMED} instance with the previously specified code and
		 * details.
		 * @return a new {@link Health_RENAMED} instance
		 */
		public Health_RENAMED build() {
			return new Health_RENAMED(this);
		}
