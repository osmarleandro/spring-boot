 ...
 * @since 2.0.0
 */
public class CachingOperationInvokerAdvisor_RENAMED implements OperationInvokerAdvisor {

	private final Function<EndpointId, Long> endpointIdTimeToLive;

	public CachingOperationInvokerAdvisor_RENAMED(Function<EndpointId, Long> endpointIdTimeToLive) {
