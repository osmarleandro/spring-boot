 ...
 * @since 2.0.0
 */
public class RegistrationMappingDescription_RENAMED<T extends Registration> {

	private final T registration;

	/**
	 * Creates a new {@link RegistrationMappingDescription_RENAMED} derived from the given
	 * {@code registration} and with the given {@code predicate}.
	 * @param registration the registration
	 */
	public RegistrationMappingDescription_RENAMED(T registration) {
