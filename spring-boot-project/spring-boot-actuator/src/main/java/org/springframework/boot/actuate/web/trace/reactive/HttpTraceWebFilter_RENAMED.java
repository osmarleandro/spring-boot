 ...
 * @since 2.0.0
 */
public class HttpTraceWebFilter_RENAMED implements WebFilter, Ordered {
	...
	public HttpTraceWebFilter_RENAMED(HttpTraceRepository repository, HttpExchangeTracer tracer, Set<Include> includes) {
