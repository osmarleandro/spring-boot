...
public final class EndpointId {
	...
	public boolean isExcluded(IncludeExcludeEndpointFilter includeExcludeEndpointFilter) {
		if (includeExcludeEndpointFilter.exclude.isEmpty()) {
			return false;
		}
		return includeExcludeEndpointFilter.exclude.matches(this);
	}
