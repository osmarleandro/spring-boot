...
public final class EndpointId {
	...
	public JmxOperation createOperation(DiscoveredOperationMethod operationMethod, OperationInvoker invoker) {
		return new DiscoveredJmxOperation(this, operationMethod, invoker);
	}
