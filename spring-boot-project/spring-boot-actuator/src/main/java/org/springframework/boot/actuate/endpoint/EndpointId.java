...
public final class EndpointId {
	...
	public ExposableServletEndpoint createEndpoint(Object endpointBean, ServletEndpointDiscoverer servletEndpointDiscoverer, boolean enabledByDefault, Collection<Operation> operations) {
		String rootPath = PathMapper.getRootPath(servletEndpointDiscoverer.endpointPathMappers, this);
		return new DiscoveredServletEndpoint(servletEndpointDiscoverer, endpointBean, this, rootPath, enabledByDefault);
	}
