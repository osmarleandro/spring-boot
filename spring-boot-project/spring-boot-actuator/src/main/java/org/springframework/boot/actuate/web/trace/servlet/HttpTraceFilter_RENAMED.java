 ...
 * @since 2.0.0
 */
public class HttpTraceFilter_RENAMED extends OncePerRequestFilter implements Ordered {
	...
	/**
	 * Create a new {@link HttpTraceFilter_RENAMED} instance.
	 * @param repository the trace repository
	 * @param tracer used to trace exchanges
	 */
	public HttpTraceFilter_RENAMED(HttpTraceRepository repository, HttpExchangeTracer tracer) {
