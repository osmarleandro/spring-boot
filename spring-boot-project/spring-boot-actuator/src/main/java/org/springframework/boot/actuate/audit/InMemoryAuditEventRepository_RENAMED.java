 ...
 * @since 1.0.0
 */
public class InMemoryAuditEventRepository_RENAMED implements AuditEventRepository {
	...
	public InMemoryAuditEventRepository_RENAMED() {
		this(DEFAULT_CAPACITY);
	}

	public InMemoryAuditEventRepository_RENAMED(int capacity) {
