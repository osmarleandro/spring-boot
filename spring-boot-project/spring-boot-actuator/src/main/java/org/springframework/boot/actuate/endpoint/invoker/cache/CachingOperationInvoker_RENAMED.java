 ...
 * @since 2.0.0
 */
public class CachingOperationInvoker_RENAMED implements OperationInvoker {
	 ...
	 */
	CachingOperationInvoker_RENAMED(OperationInvoker invoker, long timeToLive) {
	...
	public static OperationInvoker apply(OperationInvoker invoker, long timeToLive) {
		if (timeToLive > 0) {
			return new CachingOperationInvoker_RENAMED(invoker, timeToLive);
		}
		return invoker;
	}
