 ...
 * @since 2.1.0
 */
public class MetricsWebClientFilterFunction_RENAMED implements ExchangeFilterFunction {

	private static final String METRICS_WEBCLIENT_START_TIME = MetricsWebClientFilterFunction_RENAMED.class.getName()
			+ ".START_TIME";
	 ...
	 * @since 2.2.0
	 */
	public MetricsWebClientFilterFunction_RENAMED(MeterRegistry meterRegistry, WebClientExchangeTagsProvider tagProvider,
