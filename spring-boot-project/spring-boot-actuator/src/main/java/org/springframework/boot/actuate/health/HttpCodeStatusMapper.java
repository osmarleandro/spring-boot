...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void showComponentsWhenShowComponentsIsWhenAuthorizedAndUserDoesNotHaveRightAuthoritiesReturnsFalse(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
