...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void showComponentsWhenShowComponentsIsWhenAuthorizedAndUserHasRightAuthoritiesReturnsTrue(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
		...
		assertThat(group.showComponents(autoConfiguredHealthEndpointGroupTests.securityContext)).isTrue();
	}
