...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void showComponentsWhenShowComponentsIsNeverReturnsFalse(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
		AutoConfiguredHealthEndpointGroup group = new AutoConfiguredHealthEndpointGroup((name) -> true,
				autoConfiguredHealthEndpointGroupTests.statusAggregator, this, Show.NEVER, Show.ALWAYS, Collections.emptySet());
