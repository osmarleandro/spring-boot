...
public interface HttpCodeStatusMapper {
	...
	default boolean isMember(AutoConfiguredHealthEndpointGroup autoConfiguredHealthEndpointGroup, String name) {
		return autoConfiguredHealthEndpointGroup.members.test(name);
	}
