...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void showDetailsWhenShowDetailsIsWhenAuthorizedAndRolesAreEmptyReturnsTrue(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
