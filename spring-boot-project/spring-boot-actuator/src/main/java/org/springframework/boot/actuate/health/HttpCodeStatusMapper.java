...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void showDetailsWhenShowDetailsIsWhenAuthorizedAndUserIsNotInRoleReturnsFalse(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
