...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void showDetailsWhenShowDetailsIsWhenAuthorizedAndPrincipalIsNullReturnsFalse(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
		AutoConfiguredHealthEndpointGroup group = new AutoConfiguredHealthEndpointGroup((name) -> true,
				autoConfiguredHealthEndpointGroupTests.statusAggregator, this, null, Show.WHEN_AUTHORIZED, Collections.emptySet());
