...
public interface HttpCodeStatusMapper {
	...
	@Test
	default
	void getStatusAggregatorReturnsStatusAggregator(AutoConfiguredHealthEndpointGroupTests autoConfiguredHealthEndpointGroupTests) {
		...
		assertThat(group.getStatusAggregator()).isSameAs(autoConfiguredHealthEndpointGroupTests.statusAggregator);
	}
