...
public class ReactiveHealthEndpointWebExtension
	...
	@ReadOperation
	public Mono<WebEndpointResponse<? extends HealthComponent>> health(ApiVersion_RENAMED apiVersion,
	...
	@Override
	protected Mono<? extends HealthComponent> aggregateContributions(ApiVersion_RENAMED apiVersion,
