...
public interface AutoTimer {
	...
	public default void onError(MetricsWebFilter metricsWebFilter, ServerWebExchange exchange, long start, Throwable cause) {
		ServerHttpResponse response = exchange.getResponse();
		if (response.isCommitted()) {
			metricsWebFilter.record(exchange, start, cause);
		}
		else {
