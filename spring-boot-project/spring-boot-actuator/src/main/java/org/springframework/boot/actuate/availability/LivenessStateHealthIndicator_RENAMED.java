 ...
 * @since 2.3.0
 */
public class LivenessStateHealthIndicator_RENAMED extends AvailabilityStateHealthIndicator {

	public LivenessStateHealthIndicator_RENAMED(ApplicationAvailability availability) {
