 ...
 * @since 2.1.0
 */
public class PrometheusPushGatewayManager_RENAMED {

	private static final Log logger = LogFactory.getLog(PrometheusPushGatewayManager_RENAMED.class);
	...
	/**
	 * Create a new {@link PrometheusPushGatewayManager_RENAMED} instance using a single threaded
	 * {@link TaskScheduler}.
	 ...
	 * context is closed.
	 */
	public PrometheusPushGatewayManager_RENAMED(PushGateway pushGateway, CollectorRegistry registry, Duration pushRate,
	...
	/**
	 * Create a new {@link PrometheusPushGatewayManager_RENAMED} instance.
	 * @param pushGateway the source push gateway
	 * @param registry the collector registry to push
	 ...
	 * context is closed.
	 */
	public PrometheusPushGatewayManager_RENAMED(PushGateway pushGateway, CollectorRegistry registry, TaskScheduler scheduler,
