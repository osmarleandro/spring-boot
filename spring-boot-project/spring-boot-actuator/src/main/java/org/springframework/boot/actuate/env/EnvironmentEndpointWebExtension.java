...
public class EnvironmentEndpointWebExtension {
	...
	@ReadOperation
	public WebEndpointResponse_RENAMED<EnvironmentEntryDescriptor> environmentEntry(@Selector String toMatch) {
		EnvironmentEntryDescriptor descriptor = this.delegate.environmentEntry(toMatch);
		return (descriptor.getProperty() != null) ? new WebEndpointResponse_RENAMED<>(descriptor, WebEndpointResponse_RENAMED.STATUS_OK)
