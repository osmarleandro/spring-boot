 ...
 * @since 2.0.0
 */
public class DataSourcePoolMetrics_RENAMED implements MeterBinder {
	...
	public DataSourcePoolMetrics_RENAMED(DataSource dataSource, Collection<DataSourcePoolMetadataProvider> metadataProviders,
	...
	public DataSourcePoolMetrics_RENAMED(DataSource dataSource, DataSourcePoolMetadataProvider metadataProvider, String name,
			Iterable<Tag> tags) {
