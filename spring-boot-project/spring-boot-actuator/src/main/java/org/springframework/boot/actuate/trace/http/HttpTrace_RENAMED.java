 ...
 * @since 2.0.0
 */
public final class HttpTrace_RENAMED {
	 ...
	 * @since 2.1.0
	 */
	public HttpTrace_RENAMED(Request request, Response response, Instant timestamp, Principal principal, Session session,
			Long timeTaken) {
	...
	HttpTrace_RENAMED(TraceableRequest request) {
