 ...
 * @since 2.1.0
 */
public class TomcatMetricsBinder_RENAMED implements ApplicationListener<ApplicationStartedEvent>, DisposableBean {
	...
	public TomcatMetricsBinder_RENAMED(MeterRegistry meterRegistry) {
		this(meterRegistry, Collections.emptyList());
	}

	public TomcatMetricsBinder_RENAMED(MeterRegistry meterRegistry, Iterable<Tag> tags) {
