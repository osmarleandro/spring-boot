 ...
 * @since 1.1.0
 */
public abstract class AbstractHealthIndicator_RENAMED implements HealthIndicator {
	...
	/**
	 * Create a new {@link AbstractHealthIndicator_RENAMED} instance with a default
	 * {@code healthCheckFailedMessage}.
	 */
	protected AbstractHealthIndicator_RENAMED() {
		this(NO_MESSAGE);
	}

	/**
	 * Create a new {@link AbstractHealthIndicator_RENAMED} instance with a specific message to
	 * log when the health check fails.
	 * @param healthCheckFailedMessage the message to log on health check failure
	 * @since 2.0.0
	 */
	protected AbstractHealthIndicator_RENAMED(String healthCheckFailedMessage) {
	 ...
	 * @since 2.0.0
	 */
	protected AbstractHealthIndicator_RENAMED(Function<Exception, String> healthCheckFailedMessage) {
