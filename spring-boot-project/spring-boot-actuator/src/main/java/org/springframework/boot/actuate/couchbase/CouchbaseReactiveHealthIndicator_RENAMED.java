 ...
 * @since 2.1.0
 */
public class CouchbaseReactiveHealthIndicator_RENAMED extends AbstractReactiveHealthIndicator {

	private final Cluster cluster;

	/**
	 * Create a new {@link CouchbaseReactiveHealthIndicator_RENAMED} instance.
	 * @param cluster the Couchbase cluster
	 */
	public CouchbaseReactiveHealthIndicator_RENAMED(Cluster cluster) {
