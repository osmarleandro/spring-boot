 ...
 * @since 2.0.0
 */
public class Neo4jHealthIndicator_RENAMED extends AbstractHealthIndicator {

	private static final Log logger = LogFactory.getLog(Neo4jHealthIndicator_RENAMED.class);
	...
	public Neo4jHealthIndicator_RENAMED(Driver driver) {
