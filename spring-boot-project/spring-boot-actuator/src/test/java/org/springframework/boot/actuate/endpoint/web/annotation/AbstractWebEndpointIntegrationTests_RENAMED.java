 ...
 */
public abstract class AbstractWebEndpointIntegrationTests_RENAMED<T extends ConfigurableApplicationContext & AnnotationConfigRegistry> {
	...
	protected AbstractWebEndpointIntegrationTests_RENAMED(Supplier<T> applicationContextSupplier,
