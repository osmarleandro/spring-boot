...
class HealthEndpointWebExtensionTests
	...
	void healthReturnsSystemHealth() {
		...
		WebEndpointResponse_RENAMED<HealthComponent> response = create(this.registry, this.groups).health(ApiVersion.LATEST,
	...
	void healthWithNoContributorReturnsUp() {
		...
		WebEndpointResponse_RENAMED<HealthComponent> response = create(this.registry,
