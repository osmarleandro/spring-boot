 ...
 */
class MvcWebEndpointIntegrationTests_RENAMED
		extends AbstractWebEndpointIntegrationTests<AnnotationConfigServletWebServerApplicationContext> {

	MvcWebEndpointIntegrationTests_RENAMED() {
		super(MvcWebEndpointIntegrationTests_RENAMED::createApplicationContext,
				MvcWebEndpointIntegrationTests_RENAMED::applyAuthenticatedConfiguration);
	}
