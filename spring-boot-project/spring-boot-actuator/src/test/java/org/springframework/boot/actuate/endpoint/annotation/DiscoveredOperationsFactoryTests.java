...
class DiscoveredOperationsFactoryTests {
	...
	void createOperationsWhenHasReadMethodShouldCreateOperation() {
		Collection<TestOperation> operations = this.factory.createOperations_RENAMED(EndpointId.of("test"), new ExampleRead());
	...
	void createOperationsWhenHasWriteMethodShouldCreateOperation() {
		Collection<TestOperation> operations = this.factory.createOperations_RENAMED(EndpointId.of("test"), new ExampleWrite());
		assertThat(operations).hasSize(1);
		TestOperation operation = getFirst(operations);
	...
	void createOperationsWhenHasDeleteMethodShouldCreateOperation() {
		Collection<TestOperation> operations = this.factory.createOperations_RENAMED(EndpointId.of("test"),
				new ExampleDelete());
		assertThat(operations).hasSize(1);
		TestOperation operation = getFirst(operations);
	...
	void createOperationsShouldProvideOperationMethod() {
		TestOperation operation = getFirst(
				this.factory.createOperations_RENAMED(EndpointId.of("test"), new ExampleWithParams()));
	...
	void createOperationShouldApplyAdvisors() {
		...
		TestOperation operation = getFirst(this.factory.createOperations_RENAMED(EndpointId.of("test"), new ExampleRead()));
