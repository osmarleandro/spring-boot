...
class WebFluxEndpointIntegrationTests_RENAMED
	...
	WebFluxEndpointIntegrationTests_RENAMED() {
		super(WebFluxEndpointIntegrationTests_RENAMED::createApplicationContext,
				WebFluxEndpointIntegrationTests_RENAMED::applyAuthenticatedConfiguration);
