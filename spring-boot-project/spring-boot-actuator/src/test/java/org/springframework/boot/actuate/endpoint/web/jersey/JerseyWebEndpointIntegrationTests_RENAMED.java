 ...
 */
public class JerseyWebEndpointIntegrationTests_RENAMED
		extends AbstractWebEndpointIntegrationTests<AnnotationConfigServletWebServerApplicationContext> {

	public JerseyWebEndpointIntegrationTests_RENAMED() {
		super(JerseyWebEndpointIntegrationTests_RENAMED::createApplicationContext,
				JerseyWebEndpointIntegrationTests_RENAMED::applyAuthenticatedConfiguration);
	}
