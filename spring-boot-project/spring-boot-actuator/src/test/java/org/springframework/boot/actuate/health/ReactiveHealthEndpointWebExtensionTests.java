...
class ReactiveHealthEndpointWebExtensionTests extends
	...
	void healthReturnsSystemHealth() {
		...
		WebEndpointResponse_RENAMED<? extends HealthComponent> response = create(this.registry, this.groups)
	...
	void healthWithNoContributorReturnsUp() {
		...
		WebEndpointResponse_RENAMED<? extends HealthComponent> response = create(this.registry,
