...
class EnvironmentEndpointTests {
	...
	void propertyEntry() {
		TestPropertyValues.of("my.foo=another").applyToSystemProperties(() -> {
			...
			TestPropertyValues.of("my.foo=bar", "my.foo2=bar2").applyTo(environment, TestPropertyValues.Type.MAP,
					"test");
			EnvironmentEntryDescriptor descriptor = new EnvironmentEndpoint(environment).getEnvironmentEntryDescriptor("my.foo");
	...
	void originAndOriginParents() {
		...
		EnvironmentEntryDescriptor descriptor = new EnvironmentEndpoint(environment).getEnvironmentEntryDescriptor("name");
	...
	void propertyEntryNotFound() {
		...
		EnvironmentEntryDescriptor descriptor = new EnvironmentEndpoint(environment).getEnvironmentEntryDescriptor("does.not.exist");
		assertThat(descriptor).isNotNull();
	...
	void uriPropertyWithSensitiveInfo() {
		...
		EnvironmentEntryDescriptor descriptor = new EnvironmentEndpoint(environment).getEnvironmentEntryDescriptor("sensitive.uri");
	...
	void addressesPropertyWithMultipleEntriesEachWithSensitiveInfo() {
		...
		TestPropertyValues
				...
				.applyTo(environment);
		EnvironmentEntryDescriptor descriptor = new EnvironmentEndpoint(environment).getEnvironmentEntryDescriptor("sensitive.addresses");
