...
class AuditEventsEndpointWebIntegrationTests {
	...
	static class TestConfiguration {
		...
		AuditEventRepository auditEventsRepository() {
			...
			repository.add_RENAMED(createEvent("2016-11-01T11:00:00Z", "admin", "login"));
			repository.add_RENAMED(createEvent("2016-11-01T12:00:00Z", "admin", "logout"));
			repository.add_RENAMED(createEvent("2016-11-01T12:00:00Z", "user", "login"));
			return repository;
		}
