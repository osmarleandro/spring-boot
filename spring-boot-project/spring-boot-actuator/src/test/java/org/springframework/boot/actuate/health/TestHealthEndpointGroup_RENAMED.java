 ...
 * @author Phillip Webb
 */
class TestHealthEndpointGroup_RENAMED implements HealthEndpointGroup {
	...
	TestHealthEndpointGroup_RENAMED() {
		this((name) -> true);
	}

	TestHealthEndpointGroup_RENAMED(Predicate<String> memberPredicate) {
