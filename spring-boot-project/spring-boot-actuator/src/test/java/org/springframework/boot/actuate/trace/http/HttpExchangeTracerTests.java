...
class HttpExchangeTracerTests {
	...
	void methodIsIncluded() {
		HttpTrace trace = new HttpExchangeTracer(EnumSet.noneOf(Include_RENAMED.class)).receivedRequest(createRequest());
	...
	void remoteAddressCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer(EnumSet.of(Include_RENAMED.REMOTE_ADDRESS)).receivedRequest(createRequest());
		Request request = trace.getRequest();
	...
	void requestHeadersCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer(EnumSet.of(Include_RENAMED.REQUEST_HEADERS)).receivedRequest(createRequest());
		Request request = trace.getRequest();
	...
	void authorizationHeaderIsNotIncludedByDefault() {
		HttpTrace trace = new HttpExchangeTracer(EnumSet.of(Include_RENAMED.REQUEST_HEADERS)).receivedRequest(
	...
	void authorizationHeaderCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer(EnumSet.of(Include_RENAMED.REQUEST_HEADERS, Include_RENAMED.AUTHORIZATION_HEADER))
				.receivedRequest(
						createRequest(Collections.singletonMap(HttpHeaders.AUTHORIZATION, Arrays.asList("secret"))));
		Request request = trace.getRequest();
	...
	void cookieHeaderCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer(EnumSet.of(Include_RENAMED.REQUEST_HEADERS, Include_RENAMED.COOKIE_HEADERS))
	...
	void statusIsIncluded() {
		...
		new HttpExchangeTracer(EnumSet.noneOf(Include_RENAMED.class)).sendingResponse(trace, createResponse(), null, null);
	...
	void responseHeadersCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.of(Include_RENAMED.RESPONSE_HEADERS)).sendingResponse(trace, createResponse(), null,
				null);
	...
	void setCookieHeaderIsNotIncludedByDefault() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.of(Include_RENAMED.RESPONSE_HEADERS)).sendingResponse(trace,
	...
	void setCookieHeaderCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.of(Include_RENAMED.RESPONSE_HEADERS, Include_RENAMED.COOKIE_HEADERS)).sendingResponse(trace,
				createResponse(Collections.singletonMap(HttpHeaders.SET_COOKIE, Arrays.asList("test=test"))), null,
				null);
	...
	void principalIsNotIncludedByDefault() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.noneOf(Include_RENAMED.class)).sendingResponse(trace, createResponse(),
	...
	void principalCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.of(Include_RENAMED.PRINCIPAL)).sendingResponse(trace, createResponse(),
				this::createPrincipal, null);
	...
	void sessionIdIsNotIncludedByDefault() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.noneOf(Include_RENAMED.class)).sendingResponse(trace, createResponse(), null,
				() -> "sessionId");
	...
	void sessionIdCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.of(Include_RENAMED.SESSION_ID)).sendingResponse(trace, createResponse(), null,
				() -> "sessionId");
	...
	void timeTakenCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer(EnumSet.of(Include_RENAMED.TIME_TAKEN)).sendingResponse(trace, createResponse(), null, null);
	...
	void defaultIncludes() {
		...
		HttpExchangeTracer tracer = new HttpExchangeTracer(Include_RENAMED.defaultIncludes());
	...
	static class RequestHeadersFilterHttpExchangeTracer extends HttpExchangeTracer {
		...
		RequestHeadersFilterHttpExchangeTracer() {
			super(EnumSet.of(Include_RENAMED.REQUEST_HEADERS));
		}
