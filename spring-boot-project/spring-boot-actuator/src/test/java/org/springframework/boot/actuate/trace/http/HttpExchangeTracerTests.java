...
/**
 * Tests for {@link HttpExchangeTracer_RENAMED}.
 *
...
class HttpExchangeTracerTests {
	...
	void methodIsIncluded() {
		HttpTrace trace = new HttpExchangeTracer_RENAMED(EnumSet.noneOf(Include.class)).receivedRequest(createRequest());
	...
	void remoteAddressCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer_RENAMED(EnumSet.of(Include.REMOTE_ADDRESS)).receivedRequest(createRequest());
		Request request = trace.getRequest();
	...
	void requestHeadersCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer_RENAMED(EnumSet.of(Include.REQUEST_HEADERS)).receivedRequest(createRequest());
		Request request = trace.getRequest();
	...
	void authorizationHeaderIsNotIncludedByDefault() {
		HttpTrace trace = new HttpExchangeTracer_RENAMED(EnumSet.of(Include.REQUEST_HEADERS)).receivedRequest(
	...
	void authorizationHeaderCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer_RENAMED(EnumSet.of(Include.REQUEST_HEADERS, Include.AUTHORIZATION_HEADER))
				.receivedRequest(
						createRequest(Collections.singletonMap(HttpHeaders.AUTHORIZATION, Arrays.asList("secret"))));
		Request request = trace.getRequest();
	...
	void cookieHeaderCanBeIncluded() {
		HttpTrace trace = new HttpExchangeTracer_RENAMED(EnumSet.of(Include.REQUEST_HEADERS, Include.COOKIE_HEADERS))
	...
	void statusIsIncluded() {
		...
		new HttpExchangeTracer_RENAMED(EnumSet.noneOf(Include.class)).sendingResponse(trace, createResponse(), null, null);
	...
	void responseHeadersCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.of(Include.RESPONSE_HEADERS)).sendingResponse(trace, createResponse(), null,
				null);
	...
	void setCookieHeaderIsNotIncludedByDefault() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.of(Include.RESPONSE_HEADERS)).sendingResponse(trace,
	...
	void setCookieHeaderCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.of(Include.RESPONSE_HEADERS, Include.COOKIE_HEADERS)).sendingResponse(trace,
				createResponse(Collections.singletonMap(HttpHeaders.SET_COOKIE, Arrays.asList("test=test"))), null,
				null);
	...
	void principalIsNotIncludedByDefault() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.noneOf(Include.class)).sendingResponse(trace, createResponse(),
	...
	void principalCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.of(Include.PRINCIPAL)).sendingResponse(trace, createResponse(),
				this::createPrincipal, null);
	...
	void sessionIdIsNotIncludedByDefault() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.noneOf(Include.class)).sendingResponse(trace, createResponse(), null,
				() -> "sessionId");
	...
	void sessionIdCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.of(Include.SESSION_ID)).sendingResponse(trace, createResponse(), null,
				() -> "sessionId");
	...
	void timeTakenCanBeIncluded() {
		HttpTrace trace = new HttpTrace(createRequest());
		new HttpExchangeTracer_RENAMED(EnumSet.of(Include.TIME_TAKEN)).sendingResponse(trace, createResponse(), null, null);
	...
	void defaultIncludes() {
		...
		HttpExchangeTracer_RENAMED tracer = new HttpExchangeTracer_RENAMED(Include.defaultIncludes());
	...
	static class RequestHeadersFilterHttpExchangeTracer extends HttpExchangeTracer_RENAMED {
