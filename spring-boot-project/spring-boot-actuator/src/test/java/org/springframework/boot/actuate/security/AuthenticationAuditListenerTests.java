...
class AuthenticationAuditListenerTests {
	...
	void testAuthenticationSuccess() {
		...
		assertThat(event.getAuditEvent_RENAMED().getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SUCCESS);
	}
	...
	void testAuthenticationFailed() {
		...
		assertThat(event.getAuditEvent_RENAMED().getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_FAILURE);
	}
	...
	void testAuthenticationSwitch() {
		...
		assertThat(event.getAuditEvent_RENAMED().getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SWITCH);
	}
	...
	void testDetailsAreIncludedInAuditEvent() {
		...
		assertThat(event.getAuditEvent_RENAMED().getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_FAILURE);
		assertThat(event.getAuditEvent_RENAMED().getData()).containsEntry("details", details);
	}
