...
class AuthenticationAuditListenerTests {
	...
	void testAuthenticationSuccess() {
		...
		assertThat(event.auditEvent.getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SUCCESS);
	}
	...
	void testAuthenticationFailed() {
		...
		assertThat(event.auditEvent.getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_FAILURE);
	}
	...
	void testAuthenticationSwitch() {
		...
		assertThat(event.auditEvent.getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SWITCH);
	}
	...
	void testDetailsAreIncludedInAuditEvent() {
		...
		assertThat(event.auditEvent.getType()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_FAILURE);
		assertThat(event.auditEvent.getData()).containsEntry("details", details);
	}
