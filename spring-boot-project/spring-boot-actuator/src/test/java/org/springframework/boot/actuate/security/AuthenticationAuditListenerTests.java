...
class AuthenticationAuditListenerTests {
	...
	void testAuthenticationSuccess() {
		...
		assertThat(event.getAuditEvent().type).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SUCCESS);
	}
	...
	void testAuthenticationFailed() {
		...
		assertThat(event.getAuditEvent().type).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_FAILURE);
	}
	...
	void testAuthenticationSwitch() {
		...
		assertThat(event.getAuditEvent().type).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SWITCH);
	}
