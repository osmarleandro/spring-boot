...
/**
 * Tests for {@link AuthenticationAuditListener_RENAMED}.
 */
class AuthenticationAuditListenerTests {

	private final AuthenticationAuditListener_RENAMED listener = new AuthenticationAuditListener_RENAMED();
	...
	void testAuthenticationSuccess() {
		...
		assertThat(event.getAuditEvent().getType()).isEqualTo(AuthenticationAuditListener_RENAMED.AUTHENTICATION_SUCCESS);
	}
	...
	void testAuthenticationFailed() {
		...
		assertThat(event.getAuditEvent().getType()).isEqualTo(AuthenticationAuditListener_RENAMED.AUTHENTICATION_FAILURE);
	}
	...
	void testAuthenticationSwitch() {
		...
		assertThat(event.getAuditEvent().getType()).isEqualTo(AuthenticationAuditListener_RENAMED.AUTHENTICATION_SWITCH);
	}
