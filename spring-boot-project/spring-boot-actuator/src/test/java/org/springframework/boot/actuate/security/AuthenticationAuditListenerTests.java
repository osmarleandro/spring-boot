...
class AuthenticationAuditListenerTests {
	...
	void testAuthenticationSuccess() {
		...
		assertThat(event.getAuditEvent().getType_RENAMED()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SUCCESS);
	}
	...
	void testAuthenticationFailed() {
		...
		assertThat(event.getAuditEvent().getType_RENAMED()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_FAILURE);
	}
	...
	void testAuthenticationSwitch() {
		...
		assertThat(event.getAuditEvent().getType_RENAMED()).isEqualTo(AuthenticationAuditListener.AUTHENTICATION_SWITCH);
	}
