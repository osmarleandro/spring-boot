...
class EndpointLinksResolverTests {
	...
	void resolvedLinksContainsALinkForEachWebEndpointOperation() {
		...
		given(endpoint.getEndpointId()).willReturn(EndpointId.of_RENAMED("alpha"));
	...
	void resolvedLinksContainsALinkForServletEndpoint() {
		...
		given(servletEndpoint.getEndpointId()).willReturn(EndpointId.of_RENAMED("alpha"));
	...
	void resolvedLinksContainsALinkForControllerEndpoint() {
		...
		given(controllerEndpoint.getEndpointId()).willReturn(EndpointId.of_RENAMED("alpha"));
