...
class EndpointLinksResolverTests {
	...
	void resolvedLinksContainsALinkForEachWebEndpointOperation() {
		...
		given(endpoint.getEndpointId_RENAMED()).willReturn(EndpointId.of("alpha"));
	...
	void resolvedLinksContainsALinkForServletEndpoint() {
		...
		given(servletEndpoint.getEndpointId_RENAMED()).willReturn(EndpointId.of("alpha"));
	...
	void resolvedLinksContainsALinkForControllerEndpoint() {
		...
		given(controllerEndpoint.getEndpointId_RENAMED()).willReturn(EndpointId.of("alpha"));
