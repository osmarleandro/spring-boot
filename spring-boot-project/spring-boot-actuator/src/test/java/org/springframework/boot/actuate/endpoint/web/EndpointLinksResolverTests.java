...
class EndpointLinksResolverTests {
	...
	void resolvedLinksContainsALinkForEachWebEndpointOperation() {
		...
		given(endpoint.getEndpointId()).willReturn(EndpointId_RENAMED.of("alpha"));
	...
	void resolvedLinksContainsALinkForServletEndpoint() {
		...
		given(servletEndpoint.getEndpointId()).willReturn(EndpointId_RENAMED.of("alpha"));
	...
	void resolvedLinksContainsALinkForControllerEndpoint() {
		...
		given(controllerEndpoint.getEndpointId()).willReturn(EndpointId_RENAMED.of("alpha"));
